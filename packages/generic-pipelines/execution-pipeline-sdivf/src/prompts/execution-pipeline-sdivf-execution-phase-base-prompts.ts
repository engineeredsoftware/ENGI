/**
 * ExecutionPipelineSDIVF base phase Prompts (namespace phase:base).
 * Assembled from raw_promptparts only.
 */
...
export const EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_SETUP_PROMPT = phase(
...
export const EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_DISCOVERY_PROMPT = phase(
...
export const EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_IMPLEMENTATION_PROMPT = phase(
...
export const EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_VALIDATION_PROMPT = phase(
...
export const EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_FINISH_PROMPT = phase(
...
export function executionPipelineSDIVFExecutionPhaseBasePromptFor(phaseName: string): Prompt {
  switch (String(phaseName).toLowerCase()) {
    case 'setup':
      return EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_SETUP_PROMPT;
    case 'discovery':
      return EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_DISCOVERY_PROMPT;
    case 'implementation':
      return EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_IMPLEMENTATION_PROMPT;
    case 'validation':
      return EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_VALIDATION_PROMPT;
    case 'finish':
      return EXECUTION_PIPELINE_SDIVF_EXECUTION_PHASE_FINISH_PROMPT;
    default:
      return phase(
