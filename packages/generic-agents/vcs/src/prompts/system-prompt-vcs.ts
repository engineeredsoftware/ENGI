 ...
 * versions: ["1.0.0", "2.0.0", "V26.43.0", "V26.50.0", "V48.0.0"]
 * benchmarks: [
 *   { "name": "system_coherence", "test": "Does the system prompt provide coherent instructions? Rate 0-1", "score": 0.90 },
 *   { "name": "call_site_brevity", "test": "Short enough for every hierarchy call-site?", "score": 0.85 }
 * ]
 */
...
/** Agent carrier only — lean identity/role/capabilities (not Plan capability walls). */
