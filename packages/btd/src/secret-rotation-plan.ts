...
export function buildSecretRotationFamilyRows(): SecretRotationFamilyInput[] {
  return [
    ...
    },
    {
      ...
      verificationCommand: 'pnpm --dir apps/uapi test -- --runTestsByPath tests/api/pipelineHostPreflight.test.ts --runInBand',
    ...
    },
    {
      ...
      verificationCommand: 'pnpm --dir apps/uapi exec jest --runTestsByPath tests/api/vcsRoutes.test.ts --runInBand',
    ...
    },
    {
      ...
      verificationCommand: 'pnpm --dir apps/uapi exec jest --runTestsByPath tests/api/auxillariesGithubConnectionRoute.test.ts --runInBand',
    ...
    },
    {
      ...
      verificationCommand: 'pnpm --dir apps/mcp run test:mcp -- --runTestsByPath src/__tests__/unit/auth.test.ts --runInBand',
      ...
      leakSeverity: 'interface_boundary_blocking',
      blastRadiusNote: 'MCP tool ingress pauses while API and product surfaces remain governed by their own auth rows',
    ...
    },
    {
      ...
      leakSeverity: 'interface_boundary_blocking',
      blastRadiusNote: 'ChatGPT App actions pause while API and product routes remain available under separate policies',
