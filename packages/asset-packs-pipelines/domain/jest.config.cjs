...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@bitcode/generic-asset-packs-measured-patch$': '<rootDir>/../../generic-asset-packs/measured-patch/src/index.ts',
    '^@bitcode/generic-asset-packs-measured-patch/(.*)$': '<rootDir>/../../generic-asset-packs/measured-patch/src/$1',
