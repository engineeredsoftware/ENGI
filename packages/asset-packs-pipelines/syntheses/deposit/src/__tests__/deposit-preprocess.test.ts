 ...
 *  - depositor steering (obfuscations / impermissibleSources / demandContext /
...
jest.mock('@bitcode/asset-packs-pipelines-syntheses-domain/depository-search', () => {
  const actual = jest.requireActual('@bitcode/asset-packs-pipelines-syntheses-domain/depository-search');
  return {
    ...actual,
...
import { runDepositorySearchForPipelineInput } from '@bitcode/asset-packs-pipelines-syntheses-domain/depository-search';
import {
  resolveSynthesizeAssetPacksMode,
  storeSynthesizeAssetPacksMode,
  synthesizeAssetPacksModeFromExecution,
} from '@bitcode/asset-packs-pipelines-syntheses-domain/synthesize-asset-packs';
