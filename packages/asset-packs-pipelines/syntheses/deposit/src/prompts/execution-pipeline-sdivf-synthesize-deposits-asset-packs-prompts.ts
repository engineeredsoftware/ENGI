...
import { EXECUTION_PIPELINE_SDIVF_SYNTHESIZE_ASSET_PACKS_PROMPT } from '@bitcode/asset-packs-pipelines-syntheses-domain/prompts/execution-pipeline-sdivf-synthesize-asset-packs-prompts';
