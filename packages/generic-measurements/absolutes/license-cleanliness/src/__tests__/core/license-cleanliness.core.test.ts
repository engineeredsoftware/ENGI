// @ts-nocheck
import { measureAbsoluteLicenseCleanliness, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteLicenseCleanliness', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteLicenseCleanliness({
      dataPack: {
        title: 'Test DP',
