// @ts-nocheck
import { measureAbsoluteSemanticNovelty, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteSemanticNovelty', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteSemanticNovelty({
      dataPack: {
        title: 'Test DP',
