// @ts-nocheck
import { measureAbsoluteIrreducibility, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteIrreducibility', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteIrreducibility({
      dataPack: {
        title: 'Test DP',
