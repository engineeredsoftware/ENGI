// @ts-nocheck
import { measureAbsoluteSecurityCleanliness, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteSecurityCleanliness', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteSecurityCleanliness({
      dataPack: {
        title: 'Test DP',
