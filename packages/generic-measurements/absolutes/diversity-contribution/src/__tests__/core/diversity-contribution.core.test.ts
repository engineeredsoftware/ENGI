// @ts-nocheck
import { measureAbsoluteDiversityContribution, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteDiversityContribution', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteDiversityContribution({
      dataPack: {
        title: 'Test DP',
