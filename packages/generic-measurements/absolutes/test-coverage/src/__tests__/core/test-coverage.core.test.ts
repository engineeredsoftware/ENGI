// @ts-nocheck
import { measureAbsoluteTestCoverage, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteTestCoverage', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteTestCoverage({
      dataPack: {
        title: 'Test DP',
