// @ts-nocheck
import { measureAbsoluteAuthorshipConsistency, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteAuthorshipConsistency', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteAuthorshipConsistency({
      dataPack: {
        title: 'Test DP',
