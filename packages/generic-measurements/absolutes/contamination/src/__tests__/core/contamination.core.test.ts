// @ts-nocheck
import { measureAbsoluteContamination, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteContamination', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteContamination({
      dataPack: {
        title: 'Test DP',
