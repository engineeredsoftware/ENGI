// @ts-nocheck
import { measureAbsoluteRuntimeCleanliness, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteRuntimeCleanliness', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteRuntimeCleanliness({
      dataPack: {
        title: 'Test DP',
