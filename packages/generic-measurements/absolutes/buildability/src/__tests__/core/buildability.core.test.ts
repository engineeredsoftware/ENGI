// @ts-nocheck
import { measureAbsoluteBuildability, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteBuildability', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteBuildability({
      dataPack: {
        title: 'Test DP',
