// @ts-nocheck
import { measureAbsoluteFunctionCount, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteFunctionCount', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteFunctionCount({
      dataPack: {
        title: 'Test DP',
