// @ts-nocheck
import { measureAbsoluteConfigSurface, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteConfigSurface', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteConfigSurface({
      dataPack: {
        title: 'Test DP',
