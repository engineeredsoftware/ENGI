// @ts-nocheck
import { measureAbsoluteSecretSafety, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteSecretSafety', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteSecretSafety({
      dataPack: {
        title: 'Test DP',
