// @ts-nocheck
import { measureAbsoluteDeadCodeRatio, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteDeadCodeRatio', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteDeadCodeRatio({
      dataPack: {
        title: 'Test DP',
