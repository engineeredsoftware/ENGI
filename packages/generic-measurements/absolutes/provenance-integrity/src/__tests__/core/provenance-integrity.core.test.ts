// @ts-nocheck
import { measureAbsoluteProvenanceIntegrity, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteProvenanceIntegrity', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteProvenanceIntegrity({
      dataPack: {
        title: 'Test DP',
