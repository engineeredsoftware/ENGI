// @ts-nocheck
import { measureAbsoluteDependencySpan, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteDependencySpan', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteDependencySpan({
      dataPack: {
        title: 'Test DP',
