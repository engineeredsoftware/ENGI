// @ts-nocheck
import { measureAbsoluteDuplicationInternal, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteDuplicationInternal', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteDuplicationInternal({
      dataPack: {
        title: 'Test DP',
