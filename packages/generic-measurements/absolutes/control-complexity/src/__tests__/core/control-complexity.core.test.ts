// @ts-nocheck
import { measureAbsoluteControlComplexity, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteControlComplexity', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteControlComplexity({
      dataPack: {
        title: 'Test DP',
