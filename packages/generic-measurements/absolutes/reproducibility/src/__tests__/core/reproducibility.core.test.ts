// @ts-nocheck
import { measureAbsoluteReproducibility, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteReproducibility', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteReproducibility({
      dataPack: {
        title: 'Test DP',
