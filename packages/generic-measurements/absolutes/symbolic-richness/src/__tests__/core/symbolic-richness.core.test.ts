// @ts-nocheck
import { measureAbsoluteSymbolicRichness, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteSymbolicRichness', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteSymbolicRichness({
      dataPack: {
        title: 'Test DP',
