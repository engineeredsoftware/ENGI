// @ts-nocheck
import { measureAbsoluteTestStrength, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteTestStrength', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteTestStrength({
      dataPack: {
        title: 'Test DP',
