// @ts-nocheck
import { measureAbsoluteDependencyHealth, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteDependencyHealth', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteDependencyHealth({
      dataPack: {
        title: 'Test DP',
