// @ts-nocheck
import { measureAbsoluteTestPassRate, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteTestPassRate', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteTestPassRate({
      dataPack: {
        title: 'Test DP',
