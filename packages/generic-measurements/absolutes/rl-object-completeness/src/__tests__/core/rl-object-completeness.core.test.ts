// @ts-nocheck
import { measureAbsoluteRlObjectCompleteness, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteRlObjectCompleteness', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteRlObjectCompleteness({
      dataPack: {
        title: 'Test DP',
