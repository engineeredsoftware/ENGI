// @ts-nocheck
import { measureAbsoluteInformationContent, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteInformationContent', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteInformationContent({
      dataPack: {
        title: 'Test DP',
