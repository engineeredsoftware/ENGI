// @ts-nocheck
import { measureAbsoluteDataFlowDepth, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteDataFlowDepth', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteDataFlowDepth({
      dataPack: {
        title: 'Test DP',
