// @ts-nocheck
import { measureAbsoluteTrajectoryRichness, ABSOLUTE_MEASUREMENT_KIND } from '../../index';
describe('CORE: measureAbsoluteTrajectoryRichness', () => {
  it('returns a reading for the absolute kind', () => {
    const result = measureAbsoluteTrajectoryRichness({
      dataPack: {
        title: 'Test DP',
