...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('uapi-ts-maps-runtime', SOURCE_ROOTS.uapiTsConfig, tsConfig.includes('"@bitcode/pipeline-asset-pack/read-need-review-resynthesis"') && tsConfig.includes('../packages/asset-packs-pipelines/domain/src/read-need-review-resynthesis.ts')),
