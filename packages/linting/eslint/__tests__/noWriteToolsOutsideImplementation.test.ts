...
const ASSET_PACK_IMPLEMENTATION_AGENT =
  'packages/asset-packs-pipelines/syntheses/domain/src/agents/implementation/asset-pack-synthesize-artifacts-agent.ts';
...
ruleTester.run('no-write-tools-outside-implementation', noWriteToolsOutsideImplementation, {
  valid: [
    ...
    {
      filename: 'packages/asset-packs-pipelines/syntheses/domain/src/agents/discovery/gather-context-agent.ts',
