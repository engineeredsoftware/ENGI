...
const SOURCE_ROOTS = Object.freeze({
  ...
  readingObservability: 'packages/asset-packs-pipelines/domain/src/reading-pipeline-observability.ts',
  readingOperationalTelemetry: 'packages/asset-packs-pipelines/domain/src/reading-operational-telemetry-repair-readback.ts',
  readNeedRealInference: 'packages/asset-packs-pipelines/domain/src/read-need.ts',
  ...
  pipelineLog: 'uapi/components/bitcode/pipeline/pipeline-execution-log.tsx',
  pipelineLogHeader: 'uapi/components/bitcode/pipeline/pipeline-execution-log-header.tsx',
  ...
  v38PromptBenchmarkSource: 'packages/specifying/src/canonical/prompt-benchmark-report.js',
  v38PromptBenchmarkArtifact: '.bitcode/v38-prompt-benchmark-report.json',
  v38InferenceTelemetrySource: 'packages/specifying/src/canonical/inference-telemetry-disclosure-report.js',
  v38InferenceTelemetryArtifact: '.bitcode/v38-disclosure-boundary-report.json',
  v38PtrrStackSource: 'packages/specifying/src/canonical/ptrr-failsafe-thricified-stack.js',
  v38ReadFitsSearchEmbeddingsSource: 'packages/specifying/src/canonical/read-fits-finding-search-embeddings.js',
  v39OperationalTelemetrySource: 'packages/specifying/src/canonical/v39-operational-telemetry-repair-readback.js',
  v39OperationalTelemetryArtifact: '.bitcode/v39-operational-telemetry-repair-readback.json',
  v40PromptBenchmarkSmokeSource: 'packages/specifying/src/canonical/v40-prompt-benchmark-smoke-v41-readiness.js',
  v40PromptBenchmarkSmokeArtifact: '.bitcode/v40-prompt-benchmark-smoke-v41-readiness.json',
  gate2InventorySource: 'packages/specifying/src/canonical/v41-promptpart-prompt-inventory.js',
  gate2InventoryArtifact: '.bitcode/v41-promptpart-prompt-inventory.json',
  gate3ContractsSource: 'packages/specifying/src/canonical/v41-registry-interpolation-contracts.js',
  gate3ContractsArtifact: '.bitcode/v41-registry-interpolation-contracts.json',
  gate4BaselinesSource: 'packages/specifying/src/canonical/v41-reading-prompt-benchmark-baselines.js',
  gate4BaselinesArtifact: '.bitcode/v41-reading-prompt-benchmark-baselines.json',
  gate5ReadNeedSource: 'packages/specifying/src/canonical/v41-readneed-prompt-hardening.js',
  gate5ReadNeedArtifact: '.bitcode/v41-readneed-prompt-hardening.json',
  gate6ReadFitsSource: 'packages/specifying/src/canonical/v41-readfitsfinding-prompt-hardening.js',
  gate6ReadFitsArtifact: '.bitcode/v41-readfitsfinding-prompt-hardening.json',
  gate7ConversationSource: 'packages/specifying/src/canonical/v41-conversation-tool-interface-prompt-rewrite.js',
  gate7ConversationArtifact: '.bitcode/v41-conversation-tool-interface-prompt-rewrite.json',
  packageSource: 'packages/specifying/src/canonical/v41-prompt-program-benchmark-report.js',
  packageTest: 'packages/specifying/test/v41-prompt-program-benchmark-report.test.js',
