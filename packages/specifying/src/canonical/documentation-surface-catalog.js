...
const catalogRows = Object.freeze([
  {
    ...
    routePackageBindings: ['packages/specifying/src/canonical/v21-specifying.js'],
  ...
  },
  {
    ...
    linkedGeneratedArtifacts: [DOCUMENTATION_SURFACE_CATALOG_ARTIFACT_PATH],
    routePackageBindings: ['packages/specifying/test/protocol-package-boundary.test.js'],
