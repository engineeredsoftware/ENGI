...
const SOURCE_ROOTS = Object.freeze({
  ...
  terminalPageClient: 'uapi/components/reads/ReadPageClient/ReadPageClient.tsx',
  terminalWorkbenchContract: 'uapi/components/reads/ReadsDepositReadWorkbench/ReadsDepositReadWorkbench.tsx',
  terminalRouteQuery: 'uapi/components/bitcode/pipeline/models/pipeline-selection-query.ts',
  terminalActivityHistory: 'uapi/components/bitcode/pipeline/models/pipeline-activity-history.ts',
  terminalHarnessClient: 'uapi/components/bitcode/pipeline/PipelineHostClient/pipeline-host-client.ts',
  conversationHandoff: 'uapi/components/conversations/models/conversation-terminal-handoff.ts',
  ...
  handoffTest: 'uapi/components/conversations/ConversationTerminalHandoff/ConversationTerminalHandoff.tsx',
  queryTest: 'uapi/tests/pipelineSelectionQuery.test.ts',
