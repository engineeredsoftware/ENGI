...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolCanonical: 'packages/specifying/src/canonical/v42-local-staging-mvp-rehearsal.js',
  protocolTest: 'packages/specifying/test/v42-local-staging-mvp-rehearsal.test.js',
