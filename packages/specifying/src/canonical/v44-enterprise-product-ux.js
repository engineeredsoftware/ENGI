...
const SOURCE_ROOTS = Object.freeze({
  ...
  readTest: 'apps/uapi/tests/readPageClient.test.tsx',
  depositTest: 'apps/uapi/tests/depositPageClient.test.tsx',
  protocolIndex: 'packages/specifying/src/index.js',
  protocolTypes: 'packages/specifying/src/index.d.ts',
  protocolSource: 'packages/specifying/src/canonical/v44-enterprise-product-ux.js',
  protocolTest: 'packages/specifying/test/v44-enterprise-product-ux.test.js',
