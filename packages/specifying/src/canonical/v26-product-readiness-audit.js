...
const PRODUCT_READINESS_AUDIT_ROWS = [
  ...
  },
  {
    ...
    requiredEvidence: [
      ...
      ['uapi/components/reads/ReadPageClient/ReadPageClient.tsx', 'TerminalReadScenarioPanel'],
      ['uapi/components/reads/ReadPageClient/ReadPageClient.tsx', 'TerminalLiveSummaryStrip'],
      ['uapi/components/bitcode/pipeline/models/transaction-route-readiness.ts', 'route_repository_context'],
      ['uapi/components/reads/ReadsRepositoryContextPanel/ReadsRepositoryContextPanel.tsx', 'Inventory source'],
      ['uapi/components/reads/ReadsRepositoryContextPanel/ReadsRepositoryContextPanel.tsx', 'Reconnect Connects to restore live write admission'],
      ['uapi/components/bitcode/pipeline/ExecutionContextPillRow/ExecutionContextPillRow.tsx', 'Settlement posture'],
      ['uapi/components/bitcode/pipeline/ExecutionContextPillRow/ExecutionContextPillRow.tsx', 'Repository posture'],
      ['uapi/components/bitcode/routes/ProductRouteShell/ProductRouteShell.tsx', 'repository-reconnect-required'],
      ['uapi/components/bitcode/routes/ProductRouteShell/ProductRouteShell.tsx', 'wallet-reconnect-required'],
      ['uapi/components/bitcode/pipeline/models/pipeline-activity-history.ts', "status: draft.status || 'completed'"],
      ['uapi/components/reads/ReadsReadScenarioPanel/ReadsReadScenarioPanel.tsx', 'Read-fitting Exchange review'],
      ['uapi/components/bitcode/pipeline/models/transaction-readiness.ts', 'Read closure as one sequence from reviewable Read admission'],
      ['uapi/components/bitcode/pipeline/models/pipeline-run-data.ts', 'fitQualities: coerceFitQualities'],
  ...
  },
  {
    ...
    requiredEvidence: [
      ...
      ['uapi/components/reads/ReadsReadScenarioPanel/ReadsReadScenarioPanel.tsx', 'normalizeTerminalReadFittingReview'],
  ...
  },
  {
    ...
    requiredEvidence: [
      ['uapi/components/bitcode/pipeline/models/transaction-readiness.ts', 'canSettle'],
      ['uapi/components/bitcode/pipeline/models/transaction-readiness.ts', 'repository reconnect required'],
      ['uapi/components/bitcode/pipeline/models/transaction-readiness.ts', 'wallet reconnect required'],
      ['uapi/components/bitcode/pipeline/models/transaction-route-readiness.ts', 'requireBitcodeSignedTransactionReadiness'],
      ['uapi/components/bitcode/pipeline/models/transaction-route-readiness.ts', 'repository inventory'],
      ['uapi/components/bitcode/pipeline/models/transaction-route-readiness.ts', 'readBitcodeWalletConnectionStatus'],
      ...
      ['uapi/components/auxillaries/AuxillariesProfilePane/AuxillariesProfilePane.tsx', 'Profile'],
  ...
  },
  {
    ...
    requiredEvidence: [
      ['packages/generic-mcps/bitcode/src/tools/pipeline-tools.ts', 'writeAdmission'],
      ['packages/generic-mcps/bitcode/src/types/index.ts', 'RepositoryContextSchema'],
...
const PRODUCT_MVP_EVIDENCE_BY_ID = {
  ...
  'bitcode-terminal': [
    ['uapi/components/bitcode/layout/BitcodeShellBridge/BitcodeShellBridge.tsx', 'TERMINAL_MVP_SURFACE_MAP'],
  ...
  'conversations-rich-input': [
    ['uapi/components/conversations/ConversationsOverlay/ConversationsOverlay.tsx', 'Multiple view modes (floating, sidebar, fullscreen, split-screen)'],
...
const PRODUCT_LAUNCH_EVIDENCE_BY_ID = {
  ...
  'bitcode-terminal': [
    ['uapi/components/bitcode/pipeline/models/transaction-route-readiness.ts', 'TERMINAL_COMMERCIAL_TESTNET_LAUNCH_MAP'],
