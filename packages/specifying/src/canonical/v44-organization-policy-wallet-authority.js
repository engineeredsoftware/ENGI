...
const SOURCE_ROOTS = Object.freeze({
  ...
  packageSource: 'packages/specifying/src/canonical/v44-organization-policy-wallet-authority.js',
  packageTest: 'packages/specifying/test/v44-organization-policy-wallet-authority.test.js',
