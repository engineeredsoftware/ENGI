...
export const V40_READING_PIPELINE_INTEGRATION_ROWS = Object.freeze([
  ...
  row({
    ...
    sourceRoots: [
      ...
      'packages/asset-packs-pipelines/domain/src/runtime-inference-policy.ts',
    ],
    testPaths: [
      ...
      'packages/asset-packs-pipelines/domain/src/__tests__/runtime-inference-policy.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/reading-pipeline-integration-coverage.test.ts',
    ],
  ...
  row({
    ...
    testPaths: [
      ...
      'packages/asset-packs-pipelines/domain/src/__tests__/depository-search-tool.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/embedding-config.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/discovery-semantic-mirrors.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/reading-pipeline-integration-coverage.test.ts',
    ],
  ...
  row({
    ...
    sourceRoots: [
      ...
      'packages/asset-packs-pipelines/domain/src/phases/implementation.ts',
      'packages/asset-packs-pipelines/domain/src/preprocess.ts',
    ],
    testPaths: [
      'packages/asset-packs-pipelines/domain/src/__tests__/setup-agents.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/read-fits-finding-synthesis-asset-pack-synthesis-agent.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/metrics-output.test.ts',
      'packages/asset-packs-pipelines/domain/src/__tests__/reading-pipeline-integration-coverage.test.ts',
    ],
  ...
  row({
    ...
    sourceRoots: [
      ...
      'uapi/components/bitcode/pipeline/utilities/pipeline-telemetry.ts',
    ],
    testPaths: [
    ...
    commandIds: ['pnpm --filter @bitcode/asset-packs-pipelines-domain test -- reading-operational-telemetry-repair-readback reading-interface-product-parity', 'pnpm --dir uapi exec jest tests/readingOperationalTelemetryPipelineLog.test.tsx tests/pipelineExecutionLogHeader.test.tsx'],
    requiredSourceMarkers: [
  ...
  row({
    ...
    testPaths: [
      ...
      'uapi/tests/api/pipelineHostPreflight.test.ts',
    ...
    commandIds: ['pnpm --dir uapi exec jest tests/api/readReviewRoute.test.ts tests/api/pipelineHostRoute.test.ts tests/terminalPipelineHarnessClient.test.ts', 'pnpm --filter @bitcode/api test'],
    requiredSourceMarkers: [
...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('protocol-exports-gate5', 'packages/specifying/src/index.js', protocolIndex.includes('buildV40ReadingPipelineIntegrationCoverage') && protocolTypes.includes('buildV40ReadingPipelineIntegrationCoverage')),
