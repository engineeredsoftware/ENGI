...
const SOURCE_ROOTS = Object.freeze({
  ...
  assetPackDisclosure: 'packages/asset-packs-pipelines/domain/src/asset-pack-disclosure.ts',
  ...
  v38PromptBenchmarkReport: 'packages/specifying/src/canonical/prompt-benchmark-report.js',
  v40PromptBenchmarkSmoke: 'packages/specifying/src/canonical/v40-prompt-benchmark-smoke-v41-readiness.js',
  packageSource: 'packages/specifying/src/canonical/v41-reading-prompt-benchmark-baselines.js',
  packageTest: 'packages/specifying/test/v41-reading-prompt-benchmark-baselines.test.js',
    ...
    rows.map((item) => {
      ...
      return [
        item.baselineId,
        {
          ...
          ptrrAgentFactoryCount: countMatches(joinedSource, /factoryPTRRAgent|ptrrAgent\s*\(/gu),
