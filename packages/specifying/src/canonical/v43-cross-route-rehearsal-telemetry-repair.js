...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolCanonical: 'packages/specifying/src/canonical/v43-cross-route-rehearsal-telemetry-repair.js',
  protocolTest: 'packages/specifying/test/v43-cross-route-rehearsal-telemetry-repair.test.js',
