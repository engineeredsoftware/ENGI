...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolSource: 'packages/specifying/src/canonical/v47-e2e-ip-selling-buying-tests.js',
  protocolTest: 'packages/specifying/test/v47-e2e-ip-selling-buying-tests.test.js',
