...
const SOURCE_ROOTS = Object.freeze({
  ...
  packageSource: 'packages/specifying/src/canonical/v44-reading-budget-quote-policy.js',
  packageTest: 'packages/specifying/test/v44-reading-budget-quote-policy.test.js',
