...
const SOURCE_PATHS = Object.freeze({
  ...
  packageSource: 'packages/specifying/src/canonical/v46-interface-claim-contracts.js',
  packageTest: 'packages/specifying/test/v46-interface-claim-contracts.test.js',
  ...
  mcpIngressTest: 'packages/generic-mcps/bitcode/src/__tests__/unit/pipeline-ingress-contract.test.ts',
  ...
  chatGptToolsTest: 'packages/external-apps/chatgpt/src/__tests__/chatgpt-action-contract.test.ts',
  ...
  conversationHandoffTest: 'uapi/components/conversations/ConversationTerminalHandoff/ConversationTerminalHandoff.tsx',
  conversationStreamLogTest: 'uapi/tests/conversationStreamPipelineLog.test.tsx',
  conversationSessionHistory: 'uapi/components/conversations/models/conversation-session-route-history.ts',
