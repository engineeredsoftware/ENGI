...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolSource: 'packages/specifying/src/canonical/v47-staging-testnet-deployment-rehearsal.js',
  protocolTest: 'packages/specifying/test/v47-staging-testnet-deployment-rehearsal.test.js',
