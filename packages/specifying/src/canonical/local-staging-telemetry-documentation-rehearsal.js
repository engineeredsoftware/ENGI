...
const rehearsalRows = Object.freeze([
  ...
  row({
    ...
    sourceRoots: ['BITCODE_SPEC_V35_PARITY_MATRIX.md', 'packages/specifying/src/canonical/docs-qa-alignment-report.js'],
  ...
  row({
    ...
    sourceRoots: ['.github/workflows/bitcode-gate-quality.yml', 'packages/specifying/src/canonical/v21-specifying.js'],
