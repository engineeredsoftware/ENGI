...
const SOURCE_ROOTS = Object.freeze({
  ...
  conversationStreamUiHeader: 'uapi/components/bitcode/pipeline/pipeline-execution-log-header.tsx',
  ...
  chatGptTools: 'packages/external-apps/chatgpt/src/tools.ts',
  chatGptActionContract: 'packages/btd/src/chatgpt-app-action-contract.ts',
  chatGptToolsTest: 'packages/external-apps/chatgpt/src/__tests__/tools.test.ts',
  chatGptActionContractTest: 'packages/external-apps/chatgpt/src/__tests__/chatgpt-action-contract.test.ts',
  publicDocs: 'uapi/app/docs/bitcode-docs-content.ts',
  terminalReadiness: 'uapi/components/bitcode/pipeline/models/transaction-route-readiness.ts',
