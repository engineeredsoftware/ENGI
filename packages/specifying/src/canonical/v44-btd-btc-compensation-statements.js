...
const SOURCE_ROOTS = Object.freeze({
  ...
  packageSource: 'packages/specifying/src/canonical/v44-btd-btc-compensation-statements.js',
  packageTest: 'packages/specifying/test/v44-btd-btc-compensation-statements.test.js',
