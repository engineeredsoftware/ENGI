...
const PROOF_FAMILY_DEFINITIONS = Object.freeze([
  ...
  family({
    ...
    sourceEvidence: [
      source('packages/specifying/src/canonical/v41-promptpart-prompt-inventory.js', [
        'rawPromptTextSerialized',
        'PromptPartRegistry.generic',
        'ReadNeedComprehensionSynthesis',
        'ReadFitsFindingSynthesis',
      ]),
      source('packages/specifying/src/canonical/v41-registry-interpolation-contracts.js', [
        'registryId',
        'interpolation',
        'templateVariableNames',
        'source_hash_source_safe',
      ]),
      source('packages/specifying/src/canonical/v41-prompt-program-benchmark-report.js', [
        'V41_PROMPT_PROGRAM_BENCHMARK_REPORT_ARTIFACT_PATH',
        'benchmark',
        'sourceSafe',
        'rawPrompt',
      ]),
      source('packages/specifying/test/v41-promptpart-prompt-inventory.test.js', [
        'rawPromptTextSerialized',
        'benchmarkFixtureIds',
        'ReadFitsFindingSynthesis',
      ]),
