...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolSource: 'packages/specifying/src/canonical/v47-seller-buyer-state-machine-law.js',
  protocolTest: 'packages/specifying/test/v47-seller-buyer-state-machine-law.test.js',
