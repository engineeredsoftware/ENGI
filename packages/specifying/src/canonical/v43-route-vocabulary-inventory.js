...
function buildPredicateResults(repoRoot, scan) {
  ...
  const index = readSource(repoRoot, 'packages/specifying/src/index.js');
  const declarations = readSource(repoRoot, 'packages/specifying/src/index.d.ts');
  ...
  const test = readSource(repoRoot, 'packages/specifying/test/v43-route-vocabulary-inventory.test.js');
  return [
    predicateResult(
    ...
    predicateResult('protocol-readme-records-gate2', 'packages/specifying/README.md', protocolReadme.includes('V43 Gate 2')),
    ...
    predicateResult('protocol-index-exports-gate2', 'packages/specifying/src/index.js', index.includes('buildV43RouteVocabularyInventory')),
    predicateResult('protocol-types-export-gate2', 'packages/specifying/src/index.d.ts', declarations.includes('buildV43RouteVocabularyInventory')),
    ...
    predicateResult('protocol-test-exists', 'packages/specifying/test/v43-route-vocabulary-inventory.test.js', test.includes('buildV43RouteVocabularyInventory')),
    ...
    predicateResult('migration-rows-complete', 'packages/specifying/src/canonical/v43-route-vocabulary-inventory.js', V43_ROUTE_VOCABULARY_MIGRATION_ROWS.length === V43_ROUTE_VOCABULARY_MIGRATION_ROW_IDS.length),
