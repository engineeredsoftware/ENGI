...
const SOURCE_ROOTS = Object.freeze({
  ...
  compensationBoundary: 'packages/asset-packs-pipelines/domain/src/asset-pack-settlement-rights-delivery.ts',
  ...
  protocolSource: 'packages/specifying/src/canonical/v44-scaled-network-rehearsal.js',
  protocolTest: 'packages/specifying/test/v44-scaled-network-rehearsal.test.js',
