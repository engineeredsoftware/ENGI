...
const SOURCE_PATHS = Object.freeze({
  ...
  packageSource: 'packages/specifying/src/canonical/v46-product-route-comprehension-readback.js',
  packageTest: 'packages/specifying/test/v46-product-route-comprehension-readback.test.js',
  ...
  productRouteShell: 'apps/uapi/components/bitcode/routes/product-route-shell.tsx',
  packsClient: 'apps/uapi/app/packs/PacksPageClient.tsx',
  packsModel: 'apps/uapi/components/bitcode/activity/PackActivityModel/pack-activity-model.ts',
  packsApi: 'apps/uapi/app/api/packs/activity/route.ts',
  packsTest: 'apps/uapi/tests/packsPageClient.test.tsx',
  readClient: 'apps/uapi/components/reads/ReadPageClient/ReadPageClient.tsx',
  readModel: 'apps/uapi/components/reads/models/read-route-model.ts',
  readStepModel: 'apps/uapi/components/reads/models/read-route-model.ts',
  readClientTest: 'apps/uapi/tests/readPageClient.test.tsx',
  readModelTest: 'apps/uapi/tests/readRouteModel.test.ts',
  ...
  depositClientTest: 'apps/uapi/tests/depositPageClient.test.tsx',
  depositModelTest: 'apps/uapi/tests/depositRouteModel.test.ts',
});
...
export const V46_PRODUCT_ROUTE_READBACK_ROWS = Object.freeze([
  ...
  routeRow({
    ...
    requiredCopyTokens: [
      ...
      'Review source-safe options',
      'Submit deposit',
      'Read depository state',
      'DepositAssetPackOptionSynthesis',
      'reviewable source-safe AssetPack supply options.',
      'Withheld: raw source',
