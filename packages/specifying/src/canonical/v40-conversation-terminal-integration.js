...
export const V40_CONVERSATION_TERMINAL_INTEGRATION_ROWS = Object.freeze([
  ...
  row({
    ...
    sourceRoots: [
      'uapi/components/conversations/models/conversation-writing-workspace.ts',
      'uapi/components/conversations/ConversationWritingWorkspace/ConversationWritingWorkspace.tsx',
      'uapi/components/conversations/models/conversation-source-selector.ts',
      'uapi/components/conversations/ConversationSourceSelector/ConversationSourceSelector.tsx',
  ...
  row({
    ...
    sourceRoots: [
      'uapi/components/reads/models/read-route-model.ts',
  ...
  row({
    ...
    sourceRoots: [
      ...
      'uapi/components/auxillaries/AuxillariesWalletPane/AuxillariesWalletPane.tsx',
  ...
  row({
    ...
    sourceRoots: [
      'uapi/components/conversations/models/conversation-rehearsal.ts',
      'uapi/components/conversations/ConversationRehearsalPanel/ConversationRehearsalPanel.tsx',
      'uapi/app/conversations/README.md',
      'uapi/components/README.md',
