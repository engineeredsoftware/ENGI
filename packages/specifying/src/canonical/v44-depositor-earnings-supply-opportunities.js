...
const SOURCE_ROOTS = Object.freeze({
  ...
  economicModel: 'packages/specifying/src/canonical/v44-economic-domain-model.js',
  portfolioMarketIntelligence: 'packages/specifying/src/canonical/v44-packs-portfolio-market-intelligence.js',
  optionPolicy: 'packages/asset-packs-pipelines/domain/src/deposit-asset-pack-option-policy.ts',
  earningSupplyIntelligence: 'packages/asset-packs-pipelines/domain/src/depositor-earning-supply-intelligence.ts',
  earningSupplyIntelligenceTest: 'packages/asset-packs-pipelines/domain/src/__tests__/depositor-earning-supply-intelligence.test.ts',
  depositModel: 'uapi/components/deposits/models/deposit-route-model.ts',
  depositClient: 'uapi/components/deposits/DepositPageClient/DepositPageClient.tsx',
  ...
  packageIndex: 'packages/specifying/src/index.js',
  packageTypes: 'packages/specifying/src/index.d.ts',
  packageSource: 'packages/specifying/src/canonical/v44-depositor-earnings-supply-opportunities.js',
  packageTest: 'packages/specifying/test/v44-depositor-earnings-supply-opportunities.test.js',
...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('deposit-client-renders-earnings', SOURCE_ROOTS.depositClient, sources.depositClient.includes('Opportunity roots') && sources.depositClient.includes('Earning estimate')),
    ...
    predicateResult('page-test-covers-intelligence', SOURCE_ROOTS.depositPageTest, sources.depositPageTest.includes('Earning estimate') && sources.depositPageTest.includes('DepositorEarningSupplyIntelligence')),
