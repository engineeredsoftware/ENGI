...
const SOURCE_ROOTS = Object.freeze({
  ...
  commodityState: 'packages/asset-packs-pipelines/domain/src/asset-pack-commodity-state.ts',
  scalarQuote: 'packages/asset-packs-pipelines/domain/src/btd-scalar-volume-quote.ts',
  settlementReadback: 'packages/asset-packs-pipelines/domain/src/asset-pack-settlement-rights-delivery.ts',
  interfaceDisclosure: 'packages/asset-packs-pipelines/domain/src/interface-disclosure-boundary.ts',
  depositAdmission: 'packages/asset-packs-pipelines/domain/src/deposit-asset-pack-option-admission.ts',
  depositorySearch: 'packages/asset-packs-pipelines/domain/src/depository-search.ts',
  operationalReadback: 'packages/asset-packs-pipelines/domain/src/reading-operational-telemetry-repair-readback.ts',
  readModel: 'uapi/components/reads/models/read-route-model.ts',
  ...
  readClient: 'uapi/components/reads/ReadPageClient/ReadPageClient.tsx',
  ...
  proofFamilySource: 'packages/specifying/src/canonical/v45-proof-family-artifacts.js',
  source: 'packages/specifying/src/canonical/v45-source-safe-e2e-rehearsal.js',
  test: 'packages/specifying/test/v45-source-safe-e2e-rehearsal.test.js',
