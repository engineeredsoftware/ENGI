...
function buildPredicateResults(repoRoot, index, gate2Inventory) {
  ...
  predicateResults.push(
    ...
    predicateResult(
      ...
      sourceText.substepFactories.includes('factoryAgentFailsafeGenerationExecution'),
    ),
    predicateResult(
      'substep.creates-generation-execution',
      SOURCE_ROOTS.substepFactories,
      sourceText.substepFactories.includes('factoryAgentGenerationGenerationExecution'),
    ),
    predicateResult(
      'substep.stores-ptrr-failsafe',
      SOURCE_ROOTS.substepFactories,
