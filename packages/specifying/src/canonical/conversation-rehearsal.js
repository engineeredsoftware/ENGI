...
const rehearsalRows = Object.freeze([
  ...
  row({
    ...
    sourceRoots: [
      ...
      'uapi/components/conversations/ConversationPersistencePrivacyPanel/ConversationPersistencePrivacyPanel.tsx',
  ...
  row({
    ...
    sourceRoots: [
      'uapi/components/conversations/ConversationTelemetryProofPanel/ConversationTelemetryProofPanel.tsx',
      'uapi/components/conversations/models/conversation-telemetry-proof-hooks.ts',
