...
`packages/specifying/src/canonical/v43-promotion-readiness-report.js`,
`packages/specifying/test/v43-promotion-readiness.test.js`,
...
`packages/specifying/src/canonical/v44-promotion-readiness-report.js`,
`packages/specifying/test/v44-promotion-readiness.test.js`,
...
`packages/specifying/src/canonical/v45-promotion-readiness-report.js`,
...
`packages/specifying/src/canonical/v46-promotion-readiness-report.js`,
`packages/specifying/test/v46-promotion-readiness.test.js`,
...
`packages/specifying/src/canonical/v47-promotion-readiness-report.js`,
`packages/specifying/test/v47-promotion-readiness.test.js`,
...
`packages/specifying/src/canon-posture.js` and `packages/specifying/data/state.json`
...
`packages/specifying/test/v41-registry-interpolation-contracts.test.js`,
...
`packages/specifying/src/canonical/v41-readneed-prompt-hardening.js`,
`packages/specifying/test/v41-readneed-prompt-hardening.test.js`,
...
`packages/specifying/src/canonical/v41-promotion-readiness-report.js`,
`packages/specifying/test/v41-promotion-readiness.test.js`,
...
`packages/specifying/src/canonical/v40-promotion-readiness-report.js`,
`packages/specifying/test/v40-promotion-readiness.test.js`,
...
`packages/specifying/src/canonical/v39-depository-supply-indexing.js` and the
...
`packages/specifying/src/canonical/v39-enterprise-reading-ux-state.js` and the
...
`packages/specifying/src/canonical/v39-read-need-review-resynthesis.js` and the
...
`packages/specifying/src/canonical/v39-read-fits-finding-runtime.js` and the
...
`packages/specifying/src/canonical/v39-assetpack-preview-quote-boundary.js` and
...
`packages/specifying/src/canonical/v39-settlement-rights-delivery.js` and the
...
`packages/specifying/src/canonical/v39-local-staging-reading-rehearsal.js` and
the source-safe generated artifact
...
`packages/specifying/src/canonical/inference-surface-inventory.js` and the
...
`packages/specifying/src/canonical/ptrr-failsafe-thricified-stack.js` and the
...
`packages/specifying/src/canonical/prompt-benchmark-report.js` and the
...
`packages/specifying/src/canonical/inference-telemetry-disclosure-report.js` and
...
`packages/specifying/src/canonical/read-fits-finding-search-embeddings.js` and
the source-safe generated artifact
...
`packages/specifying/src/canonical/inference-promotion-readiness-report.js`
and the source-safe generated artifact
...
`packages/specifying/src/canonical/v39-commercial-reading-promotion-readiness-report.js`
...
The package boundary is enforced by `packages/specifying` tests, the UAPI
