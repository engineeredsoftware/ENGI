...
export const PROMPTPART_GENERIC_AGENT_GENERATION_REASON: PromptPart =
  [
    ...
    'Analyze the problem, list clear steps, conclude with the optimal approach, and set confidence in [0,1].',
    'Tools: include useTools only when this step is expected to execute tools (Try/Retry task generations). Omit useTools entirely for PrepareConciseContext key-selection and other no-tool steps (Plan reason, Refine reason).',
