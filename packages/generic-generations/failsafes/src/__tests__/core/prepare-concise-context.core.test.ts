// @ts-nocheck
/**
 * Co-located pins for PrepareConciseContext (PCC) — the context failsafe base.
 *
 * Ownership: @bitcode/generic-generations-failsafes owns PCC as a FailsafeGeneration
 * base. These tests live here even while the LLM-bound factory is still hosted in
 * @bitcode/agent-generics (transitional AgentExecution coupling; see package README).
 * Agent/PTRR composition tests that *use* PCC stay in those implementing packages.
 *
 * Contract:
