...
| E2E-L2 | CI-fast SDIVF deposit+read with STAB product laws (honesty, hits, needinesses, Need validation) | open | Live `qa:deposit:local` ad-hoc; no CI-fast full SDIVF spine | MVP-E2E-2 |
