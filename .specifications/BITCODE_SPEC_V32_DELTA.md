...
Gate 2 source closure is `.proofs/v32/proof-coverage-matrix.json`, generated by `pnpm run generate:v32-proof-coverage-matrix` and checked by `pnpm run check:v32-gate2`.
...
Gate 3 source closure is `.proofs/v32/artifact-volatility-inventory.json` plus `.proofs/v32/deterministic-replay-report.json`, generated by `pnpm run generate:v32-deterministic-replay-artifacts` and checked by `pnpm run check:v32-gate3`.
...
Gate 4 source closure is `.proofs/v32/reading-pipeline-proof-coverage.json`, generated by `pnpm run generate:v32-reading-pipeline-proof-coverage` and checked by `pnpm run check:v32-reading-pipeline-proof-coverage` plus `pnpm run check:v32-gate4`.
...
Gate 5 source closure is `.proofs/v32/ledger-btd-settlement-failure-state-coverage.json`, generated by `pnpm run generate:v32-ledger-btd-settlement-failure-states` and checked by `pnpm run check:v32-ledger-btd-settlement-failure-states` plus `pnpm run check:v32-gate5`.
...
Gate 6 source closure is `.proofs/v32/interface-contract-regression-suite.json`, generated by `pnpm run generate:v32-interface-contract-regression-suites` and checked by `pnpm run check:v32-interface-contract-regression-suites` plus `pnpm run check:v32-gate6`.
...
Gate 7 source closure is `.proofs/v32/browser-accessibility-responsive-visual-proof.json`, generated by `pnpm run generate:v32-browser-accessibility-responsive-visual-proof` and checked by `pnpm run check:v32-browser-accessibility-responsive-visual-proof` plus `pnpm run check:v32-gate7`.
The focused Jest test `apps/uapi/tests/bitcodeBrowserAccessibilityResponsiveProof.test.ts` and Playwright proof `apps/uapi/tests/e2e/bitcode-browser-accessibility-responsive-proof.spec.ts` cover Terminal and Auxillaries default/guided/detail states, phone and desktop browser execution, accessibility assertions, overflow proof, reduced motion, and `no-screenshot-only-approval`.
...
- generated artifact `.proofs/v32/promotion-proof-generation-hardening.json` records dry-run, check, and promotion-plan modes, failure taxonomy, branch-protection posture, and direct-main-push denial;
...
- `check:v32-gate10` validates promoted-readiness posture and `.proofs/v32/promotion-readiness-report.json`;
- V32 promotion workflow validates source branch, local proof commands, proof/test evidence, generated `.proofs/v32/*` reports, and `BITCODE_SPEC_V32_PROVEN.md`;
...
- generated `.proofs/v32/*` artifacts, `.proofs/v32/promotion-readiness-report.json`, and source-safe `BITCODE_V32_QA.md`.
