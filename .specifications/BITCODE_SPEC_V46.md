...
- Version: `V46`
- V46 state: canonical promotion complete; V46 is the active protocol-comprehension canon and the V46 hand-authored plus generated canon are aligned
- Current canonical/latest target: `V46`
- Canonical proof-source commit: `40a32e9d61a64130c958eda1498812e25a682653`
- Draft proof-source commit: generated by `BITCODE_SPEC_V46_PROVEN.md`
...
- Scope: V46 canonical system specification for protocol comprehension, source-safe public/operator explanation, interface claim contracts, proof readback, local interface rehearsal, and promotion readiness over promoted V45 knowledge commoditization canon
...
- V46 promoted canon work does not expose unpaid source.
- V46 promoted canon work does not admit value-bearing mainnet operation.
- V46 promoted canon work does not authorize behavior outside accepted formal parity,
  proof, rehearsal, and promotion evidence.
- V46 promoted canon work does not treat notes, PR bodies, telemetry, or conversations
...
`.proofs/v46/protocol-comprehension-object-model.json`; it is generated by
...
`.proofs/v46/public-operator-claim-boundaries.json`; it is generated by
...
`.proofs/v46/product-route-comprehension-readback.json`; it is generated by
...
`.proofs/v46/interface-claim-contracts.json`; it is generated by
...
`.proofs/v46/proof-readback-operator-explanation.json`; it is generated by
...
`.proofs/v46/local-interface-comprehension-rehearsal.json`; it is generated
...
- proofArtifactPath: `.proofs/v46/inference-synthesis-proof.json`.
...
- proofArtifactPath: `.proofs/v46/prompt-completeness-proof.json`.
...
- proofArtifactPath: `.proofs/v46/static-code-analysis-proof.json`.
...
- proofArtifactPath: `.proofs/v46/verification-decisions-proof.json`.
...
- proofArtifactPath: `.proofs/v46/selection-materialization-proof.json`.
...
- proofArtifactPath: `.proofs/v46/authorization-sensitive-flow-proof.json`.
...
- proofArtifactPath: `.proofs/v46/settlement-source-to-shares-proof.json`.
...
- proofArtifactPath: `.proofs/v46/disclosure-boundary-proof.json`.
...
- proofArtifactPath: `.proofs/v46/proof-contract-proof.json`.
...
validation. Gates 2 through 7 authorize the source-safe protocol
comprehension artifacts. Gate 8 authorizes promotion readiness, the generated
V46 proof appendix, and the maintained V46 promotion workflow. The proof-family
catalog remains a future catalog until a later canon explicitly authorizes
those artifacts.
...
| --- | --- | --- |
| `.proofs/v46/spec-family-report.json` | draft spec-family validation report | Gate 1 planned |
| `.proofs/v46/canonical-input-report.json` | draft canonical input report | Gate 1 planned |
| `.proofs/v46/protocol-comprehension-object-model.json` | protocol comprehension object and claim taxonomy artifact | Gate 2 |
| `.proofs/v46/public-operator-claim-boundaries.json` | public/operator claim-boundary artifact | Gate 3 |
| `.proofs/v46/product-route-comprehension-readback.json` | product route comprehension readback artifact | Gate 4 |
| `.proofs/v46/interface-claim-contracts.json` | API/MCP, ChatGPT App, Bitcode Chat, and package-consumer claim-contract artifact | Gate 5 |
| `.proofs/v46/proof-readback-operator-explanation.json` | proof readback and source-safe operator explanation artifact | Gate 6 |
| `.proofs/v46/local-interface-comprehension-rehearsal.json` | local interface comprehension rehearsal artifact | Gate 7 |
| `.proofs/v46/promotion-readiness-report.json` | promotion-readiness artifact | Gate 8 |
| `BITCODE_SPEC_V46_PROVEN.md` | generated proof appendix | Gate 8 |
| `.proofs/v46/inference-synthesis-proof.json` | inference proof-family artifact | future proof catalog |
| `.proofs/v46/prompt-completeness-proof.json` | prompt proof-family artifact | future proof catalog |
| `.proofs/v46/static-code-analysis-proof.json` | static-code proof-family artifact | future proof catalog |
| `.proofs/v46/verification-decisions-proof.json` | verification-decision proof-family artifact | future proof catalog |
| `.proofs/v46/selection-materialization-proof.json` | selection and materialization proof-family artifact | future proof catalog |
| `.proofs/v46/authorization-sensitive-flow-proof.json` | authorization and sensitive-flow proof-family artifact | future proof catalog |
| `.proofs/v46/settlement-source-to-shares-proof.json` | settlement and allocation proof-family artifact | future proof catalog |
| `.proofs/v46/disclosure-boundary-proof.json` | disclosure-boundary proof-family artifact | future proof catalog |
| `.proofs/v46/proof-contract-proof.json` | proof-contract proof-family artifact | future proof catalog |
| `.proofs/v46/source-safe-e2e-rehearsal.json` | source-safe end-to-end rehearsal artifact | future rehearsal catalog |

### V46 specifying generated artifacts

V46 specifying generated artifacts must include `.proofs/v46/spec-family-report.json`,
...
`.proofs/v46/promotion-readiness-report.json`, and
`BITCODE_SPEC_V46_PROVEN.md`. The nine proof-family artifacts and separate
source-safe end-to-end rehearsal artifact remain cataloged future evidence, not
Gate 8 promotion prerequisites.
...
V46 promotion is Gate 8 work. It requires every accepted V46 protocol
comprehension row to be closed or explicitly deferred, source-safety to be
preserved, Gate 2 through Gate 7 artifacts to be parseable and fresh,
promotion scripts support V46, `BITCODE_SPEC_V46_PROVEN.md` generation to be
covered, and the V46 promotion workflow to validate before any standalone
`BITCODE_SPEC.txt` pointer change.

### V46 promotion readiness canon

V46 promotion readiness is current in Gate 8. Gate 8 generates
`.proofs/v46/promotion-readiness-report.json`, wires
`.github/workflows/v46-canon-promotion.yml`, binds the six accepted V46
protocol comprehension artifacts, proves source-safety exclusions, runs
`node scripts/promote-bitcode-canon.mjs --version V46 --commit HEAD --dry-run`,
and prepares the post-promotion `V46 active / draft V47` posture.
...
| --- | --- | --- | --- | --- | --- | --- |
| Inference-synthesis | `.proofs/v46/inference-synthesis-proof.json` | Reading, deposit, conversation | typed inference, source safety | synthesize, search, preview | execution receipts | formal V46 law |
| Prompt-completeness | `.proofs/v46/prompt-completeness-proof.json` | prompts, registries | total prompt catalog | resolve, interpolate | prompt inventory | formal V46 law |
| Static-code-analysis | `.proofs/v46/static-code-analysis-proof.json` | packages, routes, workflows | source alignment | lint, typecheck | CI logs | formal V46 law |
| Verification-decisions | `.proofs/v46/verification-decisions-proof.json` | review, quote, finality | actor authority | approve, select, settle | decision roots | formal V46 law |
| Selection-and-materialization | `.proofs/v46/selection-materialization-proof.json` | Fits, bundle, preview, delivery | source withheld | search, synthesize, deliver | storage roots | formal V46 law |
| Authorization-and-sensitive-flow | `.proofs/v46/authorization-sensitive-flow-proof.json` | policy, wallet, entitlement | no secret leakage | authorize, redact | policy roots | formal V46 law |
| Settlement-source-to-shares | `.proofs/v46/settlement-source-to-shares-proof.json` | BTD, BTC, allocation | finality before rights | quote, observe, allocate | ledger roots | formal V46 law |
| Disclosure-boundary | `.proofs/v46/disclosure-boundary-proof.json` | interfaces | source-safe boundary | preview, quote, delivery | interface roots | formal V46 law |
| Proof-contract | `.proofs/v46/proof-contract-proof.json` | evidence classes | proof-backed readback | readback, repair | proof roots | formal V46 law |
...
are missing. The draft generated artifacts are `.proofs/v46/spec-family-report.json`,
`.proofs/v46/canonical-input-report.json`, the six Gate 2 through Gate 7
protocol comprehension artifacts, `.proofs/v46/promotion-readiness-report.json`,
and `BITCODE_SPEC_V46_PROVEN.md`. The nine proof-family artifacts and separate
source-safe end-to-end rehearsal artifact remain future catalog rows until a
later canon authorizes them.
...
`check:v46-gate6`, `check:v46-gate7`, `check:v46-gate8`, draft V46
spec-family checks, active V45 promoted checks, V45/V46 canon posture drift
checks, V46 promotion dry-run, and later parity, proof, implementation,
rehearsal, and promotion commands.
...
`BITCODE_SPEC_V46_DELTA.md`, `BITCODE_SPEC_V46_NOTES.md`,
`BITCODE_SPEC_V46_PARITY_MATRIX.md`, `BITCODE_SPEC_V46_PROVEN.md`, and
