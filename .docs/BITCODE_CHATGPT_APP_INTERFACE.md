...
- write connected-interface changes without owner-read or licensed-read registry evidence for the relevant DataPack,
...
- `readAccess` evidence with DataPack id, wallet id, decision, access-policy hash, and reason.
...
- output payloads must normalize to Read, fit, DataPack, proof, settlement, or delivery evidence,
