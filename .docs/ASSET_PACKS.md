...
Implementation lives in `packages/asset-packs-pipelines/syntheses/domain/src/phases/execution-pipeline-sdivf-execution-phase-synthesis-deposit-asset-packs.ts`.
...
| Concern | Location |
|---------|----------|
| Deposit phase roster | `packages/asset-packs-pipelines/syntheses/domain/src/phases/execution-pipeline-sdivf-execution-phase-synthesis-deposit-asset-packs.ts` |
...
*Document owner: product + pipeline maintainers. Prefer updating this file when deposit agent roster keys, absolute catalog kinds, or Finish schemas change — keep it aligned with `execution-pipeline-sdivf-execution-phase-synthesis-deposit-asset-packs.ts` and `ASSET_PACK_ABSOLUTES_CATALOG`.*
