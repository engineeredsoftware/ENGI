...
const coverageRows = Object.freeze([
  ...
  },
  {
    ...
    fixture: 'uapi/tests/api/readReviewRoute.test.ts; uapi/tests/api/pipelineHostRoute.test.ts; uapi/tests/api/vcsRoutes.test.ts; uapi/tests/userDataRoute.test.ts; packages/api/src/routes/__tests__/btd-crypto.test.ts; uapi/tests/api/conversationsRouteRead.test.ts',
    replayCommand: 'pnpm --dir uapi exec jest --runTestsByPath tests/api/readReviewRoute.test.ts tests/api/pipelineHostRoute.test.ts tests/api/vcsRoutes.test.ts tests/userDataRoute.test.ts tests/api/conversationsRouteRead.test.ts --runInBand && pnpm --filter @bitcode/api exec jest --config jest.config.cjs --runTestsByPath src/routes/__tests__/btd-crypto.test.ts --runInBand && pnpm run check:v32-interface-contract-regression-suites',
    expectedArtifact: '.bitcode/v32-interface-contract-regression-suite.json',
    sourceSafetyClass: 'source-safe-internal',
    coverageStatus: 'v32-expansion-required',
    plannedGate: 'Gate 6',
  ...
  },
  {
    ...
    fixture: 'uapi/tests/terminalJournalReconciliation.test.ts; packages/pipeline-hosts/src/__tests__/asset-pack-host-plan.test.ts; packages/btd/__tests__/btc-fee-operation.test.ts; packages/btd/__tests__/v32-ledger-btd-settlement-failure-states.test.ts',
