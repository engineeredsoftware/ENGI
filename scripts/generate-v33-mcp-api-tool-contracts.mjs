...
const ARTIFACT_PATH = '.proofs/v33/mcp-api-tool-contracts.json';
...
export function buildV33McpApiToolContractsArtifact() {
  ...
  const sourceEvidence = [
    ...
    scanTokens('apps/mcp/src/types/index.ts', [
      'AssetPackPipelineToolSchema',
      'PipelineNameValues',
  ...
  const testEvidence = [
    ...
    scanTokens('apps/mcp/src/__tests__/unit/mcp-tool-contract.test.ts', [
