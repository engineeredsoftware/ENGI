...
test('V44 Depositor earnings supply opportunities bind source-safe deposit-side economics', () => {
  ...
  assert.equal(artifact.sourceRoots.earningSupplyIntelligence.startsWith('packages/asset-packs-pipelines/syntheses/deposit/src/depositor-earning-supply-intelligence.ts:'), true);
