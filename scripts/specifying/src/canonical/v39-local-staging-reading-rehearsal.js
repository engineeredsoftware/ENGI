...
const SOURCE_ROOTS = Object.freeze({
  rehearsal: 'packages/asset-packs-pipelines/syntheses/read/src/reading-local-staging-rehearsal.ts',
  ...
  interfaceParity: 'packages/asset-packs-pipelines/syntheses/read/src/reading-interface-product-parity.ts',
...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult(
      'roadmap-advanced-to-gate10',
      SOURCE_ROOTS.roadmap,
      roadmap.includes('V39 Gate 10 closure anchor') &&
        (/Current working gate: V39 Gate (?:10|11)\b/u.test(roadmap) ||
