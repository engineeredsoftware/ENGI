...
const SOURCE_ROOTS = Object.freeze({
  rehearsal: 'packages/asset-packs-pipelines/domain/src/reading-local-staging-rehearsal.ts',
  ...
  interfaceParity: 'packages/asset-packs-pipelines/domain/src/reading-interface-product-parity.ts',
