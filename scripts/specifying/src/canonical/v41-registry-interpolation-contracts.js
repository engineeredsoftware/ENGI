...
const SOURCE_ROOTS = Object.freeze({
  ...
  failsafeMetaSubStepPrompt: 'packages/agent-generics/src/prompts/FailsafeGenerationPrompt.ts',
  ...
  assetPackCompletionAgent: 'packages/asset-packs-pipelines/syntheses/domain/src/agents/finish/asset-pack-completion-agent.ts',
  packageSource: 'scripts/specifying/src/canonical/v41-registry-interpolation-contracts.js',
  packageTest: 'scripts/specifying/test/v41-registry-interpolation-contracts.test.js',
...
function buildPredicateResults(sourceText, gate2Inventory) {
  return [
    ...
    predicateResult(
      ...
      sourceText.assetPackSynthesisAgent.includes('factoryPTRRAgent')
