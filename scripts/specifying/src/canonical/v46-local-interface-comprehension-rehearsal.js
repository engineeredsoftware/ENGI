...
const SOURCE_PATHS = Object.freeze({
  ...
  packageSource: 'scripts/specifying/src/canonical/v46-local-interface-comprehension-rehearsal.js',
  packageTest: 'scripts/specifying/test/v46-local-interface-comprehension-rehearsal.test.js',
