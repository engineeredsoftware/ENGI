...
const SOURCE_ROOTS = Object.freeze({
  ...
  readingPipelineContractTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/reading-pipeline-contract.test.ts',
  readingPipelineObservabilityTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/reading-pipeline-observability.test.ts',
