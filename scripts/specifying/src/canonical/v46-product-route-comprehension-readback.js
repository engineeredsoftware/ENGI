...
const SOURCE_PATHS = Object.freeze({
  ...
  packageSource: 'scripts/specifying/src/canonical/v46-product-route-comprehension-readback.js',
  packageTest: 'scripts/specifying/test/v46-product-route-comprehension-readback.test.js',
