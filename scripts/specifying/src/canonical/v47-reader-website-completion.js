...
const SOURCE_ROOTS = Object.freeze({
  ...
  readRouteModelTest: 'apps/uapi/tests/readRouteModel.test.ts',
  readPageTest: 'apps/uapi/tests/readPageClient.test.tsx',
  packActivityModel: 'apps/uapi/components/bitcode/activity/PackActivityModel/pack-activity-model.ts',
  previewBoundaryModel: 'packages/asset-packs-pipelines/syntheses/domain/src/asset-pack-preview-boundary.ts',
  settlementRightsDeliveryModel:
    'packages/asset-packs-pipelines/domain/src/asset-pack-settlement-rights-delivery.ts',
  needReviewModel: 'packages/asset-packs-pipelines/syntheses/read/src/read-need-review-resynthesis.ts',
  fitsFindingModel: 'packages/asset-packs-pipelines/syntheses/read/src/read-fits-finding-runtime.ts',
  ...
  protocolSource: 'scripts/specifying/src/canonical/v47-reader-website-completion.js',
  protocolTest: 'scripts/specifying/test/v47-reader-website-completion.test.js',
