...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolCanonical: 'scripts/specifying/src/canonical/v43-cross-route-rehearsal-telemetry-repair.js',
  protocolTest: 'scripts/specifying/test/v43-cross-route-rehearsal-telemetry-repair.test.js',
