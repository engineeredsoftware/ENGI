...
const REQUIRED_SOURCE_EVIDENCE = Object.freeze([
  ...
  source('scripts/specifying/test/v47-promotion-readiness.test.js', [
...
const REQUIRED_DOCUMENTATION_EVIDENCE = Object.freeze([
  source('.specifications/BITCODE_SPEC_V47.md', [
    'V47 promotion readiness canon',
    V47_PROMOTION_READINESS_REPORT_ARTIFACT_PATH,
    'V47 active / draft V48',
  ]),
  source('.specifications/BITCODE_SPEC_V47_DELTA.md', [
    'Gate 10: V47 Promotion Readiness',
    V47_PROMOTION_READINESS_REPORT_ARTIFACT_PATH,
    'promotion scripts support V47',
  ]),
  source('.specifications/BITCODE_SPEC_V47_NOTES.md', [
    'Gate 10: V47 Promotion Readiness',
    V47_PROMOTION_READINESS_REPORT_ARTIFACT_PATH,
    'active V47 / draft V48',
  ]),
  source('.specifications/BITCODE_SPEC_V47_PARITY_MATRIX.md', [
...
export function buildV47PromotionReadinessReport(input = {}) {
  ...
  const coverage = {
    ...
    generatedProofOutputsCovered: V47_PROMOTION_READINESS_GENERATED_OUTPUTS.includes('.specifications/BITCODE_SPEC_V47_PROVEN.md'),
