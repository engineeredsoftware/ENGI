...
const SOURCE_ROOTS = Object.freeze({
  ...
  portfolioMarketIntelligence: 'scripts/specifying/src/canonical/v44-packs-portfolio-market-intelligence.js',
  optionPolicy: 'packages/asset-packs-pipelines/syntheses/deposit/src/deposit-asset-pack-option-policy.ts',
  earningSupplyIntelligence: 'packages/asset-packs-pipelines/syntheses/deposit/src/depositor-earning-supply-intelligence.ts',
  earningSupplyIntelligenceTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/depositor-earning-supply-intelligence.test.ts',
  ...
  packageIndex: 'scripts/specifying/src/index.js',
  packageTypes: 'scripts/specifying/src/index.d.ts',
  packageSource: 'scripts/specifying/src/canonical/v44-depositor-earnings-supply-opportunities.js',
  packageTest: 'scripts/specifying/test/v44-depositor-earnings-supply-opportunities.test.js',
