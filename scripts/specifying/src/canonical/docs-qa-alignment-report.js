...
export const DOCS_QA_ALIGNMENT_REPORT_ARTIFACT_PATH = '.proofs/v35/docs-qa-alignment-report.json';
...
const alignmentRows = Object.freeze([
  ...
  },
  {
    ...
    checkedSources: [
      ...
      'scripts/specifying/src/canonical/telemetry-documentation-interface-integration.js',
  ...
  },
  {
    ...
    generatedArtifacts: ['.proofs/v35/public-docs-usage-guides.json'],
  ...
  },
  {
    ...
    generatedArtifacts: ['.proofs/v35/documentation-surface-catalog.json'],
  ...
  },
  {
    ...
    checkedSources: [
      ...
      'scripts/specifying/test/v35-telemetry-documentation-interface-integration.test.js',
    ...
    generatedArtifacts: ['.proofs/v35/docs-qa-alignment-report.json'],
