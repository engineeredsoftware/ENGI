...
const guideRows = Object.freeze([
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC.txt', '.specifications/BITCODE_SPEC_V35.md', 'scripts/specifying'],
    sourceRoots: [
    ...
    packageSurfaces: ['scripts/specifying/src/index.js', 'scripts/specifying/src/canonical/v21-specifying.js'],
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', 'packages/api', 'packages/btd'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', 'apps/mcp', 'packages/api'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', 'packages/btd'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
      'packages/btd/README.md',
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', 'packages/pipelines/asset-pack'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
      'packages/asset-packs-pipelines/domain/README.md',
      'docs/BITCODE_TERMINAL_OPERATOR_EXPERIENCE.md',
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', 'scripts/specifying', 'TelemetryTaxonomyCatalog'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
      '.specifications/BITCODE_SPEC_V35.md',
      'scripts/specifying/README.md',
    ],
    packageSurfaces: ['scripts/specifying/src', 'scripts/generate-bitcode-proven.mjs'],
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', '.specifications/SPECIFICATIONS_ROADMAP.md', 'apps/uapi/app/exchange'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
  ...
  },
  {
    ...
    canonicalTruth: ['.specifications/BITCODE_SPEC_V35.md', '.specifications/SPECIFICATIONS_ROADMAP.md', 'apps/uapi/app/conversations'],
    sourceRoots: [
      'apps/uapi/app/docs/bitcode-docs-content.ts',
