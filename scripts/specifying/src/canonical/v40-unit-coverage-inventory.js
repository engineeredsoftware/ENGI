...
export const V40_UNIT_COVERAGE_ROWS = Object.freeze([
  row({
    ...
    sourceRoots: ['scripts/specifying/src/canonical', 'scripts/specifying/src/index.js'],
    testPaths: [
  ...
  row({
    ...
    packageNames: ['@bitcode/specifying', 'scripts/specifying'],
    sourceRoots: ['scripts/specifying/test/protocol-package-boundary.test.js', 'scripts/specifying'],
    testPaths: [
      'scripts/specifying/test/protocol-package-boundary.test.js',
      'scripts/specifying/test/v28-mvp-qa.test.js',
      'scripts/specifying/test/v28-boundary-separation.test.js',
      'scripts/specifying/test/local-fit-finding.test.js',
    ],
    commandIds: ['node --test scripts/specifying/test/protocol-package-boundary.test.js', 'pnpm --filter @bitcode/specifying run test:v28-mvp-qa'],
    coverageTier: 'promotion-required',
