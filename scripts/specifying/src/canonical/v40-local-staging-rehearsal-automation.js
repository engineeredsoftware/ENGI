...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolSource: 'scripts/specifying/src/canonical/v40-local-staging-rehearsal-automation.js',
  protocolTest: 'scripts/specifying/test/v40-local-staging-rehearsal-automation.test.js',
  ...
  routeTest: 'apps/uapi/tests/api/pipelineHostPreflight.test.ts',
  readingRehearsal: 'packages/asset-packs-pipelines/syntheses/read/src/reading-local-staging-rehearsal.ts',
  readingRehearsalTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/reading-local-staging-rehearsal.test.ts',
  ledgerStorageSync: 'scripts/specifying/src/canonical/v40-ledger-storage-sync.js',
  ledgerStorageSyncTest: 'scripts/specifying/test/v40-ledger-storage-sync.test.js',
...
export const V40_LOCAL_STAGING_REHEARSAL_AUTOMATION_ROWS = Object.freeze([
  ...
  row({
    ...
    commandIds: ['pnpm --dir apps/uapi exec jest --runTestsByPath tests/api/pipelineHostPreflight.test.ts --runInBand'],
