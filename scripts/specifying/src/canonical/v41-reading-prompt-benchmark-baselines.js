...
const SOURCE_ROOTS = Object.freeze({
  ...
  readingObservability: 'packages/asset-packs-pipelines/syntheses/read/src/reading-pipeline-observability.ts',
  readingAgentPrompts: 'packages/asset-packs-pipelines/syntheses/domain/src/agents/prompts',
  ...
  packageTest: 'scripts/specifying/test/v41-reading-prompt-benchmark-baselines.test.js',
