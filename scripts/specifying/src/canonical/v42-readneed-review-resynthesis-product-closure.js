...
const SOURCE_ROOTS = Object.freeze({
  ...
  readNeedRuntime: 'packages/asset-packs-pipelines/syntheses/read/src/read-need-review-resynthesis.ts',
  ...
  readNeedTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/read-need.test.ts',
  runtimeTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/read-need-review-resynthesis.test.ts',
  readingContractTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/reading-pipeline-contract.test.ts',
  readReviewRoute: 'apps/uapi/app/api/read-review/route.ts',
  readReviewRouteTest: 'apps/uapi/tests/api/readReviewRoute.test.ts',
  readReviewProtocolParityTest: 'apps/uapi/tests/api/readReviewProtocolParity.test.ts',
  terminalWorkbench: 'apps/uapi/components/reads/ReadsDepositReadWorkbench/ReadsDepositReadWorkbench.tsx',
  terminalUxState: 'apps/uapi/components/reads/models/read-route-model.ts',
  ...
  terminalReadme: 'apps/uapi/components/README.md',
...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('inference-receipt-covers-ptrr-failsafe-thricified', SOURCE_ROOTS.readNeed, readNeed.includes('ReadNeedComprehensionSynthesisInferenceReceipt') && readNeed.includes('failsafeSequenceIds') && readNeed.includes('thinkingsGenerationIds') && readNeed.includes('promptTemplateIds')),
    predicateResult('contract-has-four-phases-and-sixteen-steps', SOURCE_ROOTS.readingPipelineContract, contract.includes('ReadNeedComprehensionSynthesis.request') && contract.includes('ReadNeedComprehensionSynthesis.review') && contract.includes('ptrrStepCount') && contract.includes('thinkingsGenerationCount')),
    ...
    predicateResult('read-need-tests-cover-real-inference-receipts', SOURCE_ROOTS.readNeedTest, readNeedTest.includes('real-inference ReadNeedComprehension') && readNeedTest.includes('thinkings-generation') && readNeedTest.includes('accepted_read_need_missing')),
