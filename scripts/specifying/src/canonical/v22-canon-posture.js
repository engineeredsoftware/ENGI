...
export function buildCanonPostureDriftReport({
  ...
  const specifyingIndexPath = path.join(resolvedRepoRoot, 'scripts', 'specifying', 'src', 'index.js');
  ...
  pushCheck(
    ...
    'scripts/specifying owns @bitcode/specifying and exports buildCanonPostureDriftReport.'
  );
  pushCheck(
    checks,
