...
const SOURCE_ROOTS = Object.freeze({
  ...
  protocolSource: 'scripts/specifying/src/canonical/v44-scaled-network-rehearsal.js',
  protocolTest: 'scripts/specifying/test/v44-scaled-network-rehearsal.test.js',
