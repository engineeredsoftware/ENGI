...
function buildV32PromotionProofGenerationHardening({ generatedAt, baseData }) {
  const requiredSources = [
    ...
    {
      relativePath: 'scripts/specifying/src/canonical/proven-generator.js',
      tokens: [
    ...
    {
      relativePath: 'scripts/specifying/test/v32-promotion-proof-generation.test.js',
      tokens: [
...
function buildV32PromotionReadinessReport({ generatedAt, baseData }) {
  const requiredSources = [
    ...
    {
      relativePath: 'scripts/specifying/README.md',
      tokens: [
        'V32 Gate 10',
        'V32` active, `V33` draft'
      ]
...
function buildV34PromotionReadinessReport({ generatedAt, baseData }) {
  const requiredSources = [
    ...
    {
      relativePath: 'scripts/specifying/test/v34-promotion-readiness.test.js',
      tokens: [
