...
export const V43_READ_ROUTE_FIVE_STEP_UX_ARTIFACT_PATH = '.proofs/v43/read-route-five-step-ux.json';
...
const SOURCE_ROOTS = Object.freeze({
  ...
  routeModel: 'apps/uapi/components/reads/models/read-route-model.ts',
  page: 'apps/uapi/app/read/page.tsx',
  client: 'apps/uapi/components/reads/ReadPageClient/ReadPageClient.tsx',
  ...
  terminalReadingState: 'apps/uapi/components/reads/models/read-route-model.ts',
  ...
  packageTest: 'scripts/specifying/test/v43-read-route-five-step-ux.test.js',
  routeModelTest: 'apps/uapi/tests/readRouteModel.test.ts',
  pageTest: 'apps/uapi/tests/readPageClient.test.tsx',
