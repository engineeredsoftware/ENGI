...
const SOURCE_ROOTS = Object.freeze({
  ...
  readNeedReviewRuntime: 'packages/asset-packs-pipelines/syntheses/read/src/read-need-review-resynthesis.ts',
  ...
  uapiNextConfig: 'apps/uapi/next.config.mjs',
  uapiTsConfig: 'apps/uapi/tsconfig.json',
  v39Spec: '.specifications/BITCODE_SPEC_V39.md',
  v39Delta: '.specifications/BITCODE_SPEC_V39_DELTA.md',
  v39Notes: '.specifications/BITCODE_SPEC_V39_NOTES.md',
...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('uapi-runtime-imports-resolve-in-next-build', SOURCE_ROOTS.uapiNextConfig, nextConfig.includes("'@bitcode/asset-packs-pipelines-domain$'") && nextConfig.includes("'@bitcode/asset-packs-pipelines-execution-pipeline-sdivf-synthesize-reads-asset-packs/read-need-review-resynthesis'") && nextConfig.includes("'reading-pipeline-contract.ts'")),
    predicateResult('uapi-ts-maps-runtime', SOURCE_ROOTS.uapiTsConfig, tsConfig.includes('"@bitcode/asset-packs-pipelines-execution-pipeline-sdivf-synthesize-reads-asset-packs/read-need-review-resynthesis"') && tsConfig.includes('../packages/asset-packs-pipelines/syntheses/read/src/read-need-review-resynthesis.ts')),
