...
export const V43_DEPOSIT_OPTION_ADMISSION_ARTIFACT_PATH = '.proofs/v43/deposit-option-admission.json';
...
const SOURCE_ROOTS = Object.freeze({
  ...
  optionModel: 'packages/asset-packs-pipelines/syntheses/deposit/src/deposit-asset-pack-options.ts',
  policyModel: 'packages/asset-packs-pipelines/syntheses/deposit/src/deposit-asset-pack-option-policy.ts',
  admissionModel: 'packages/asset-packs-pipelines/syntheses/deposit/src/deposit-asset-pack-option-admission.ts',
  optionModelTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/deposit-asset-pack-options.test.ts',
  policyModelTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/deposit-asset-pack-option-policy.test.ts',
  admissionModelTest: 'packages/asset-packs-pipelines/syntheses/domain/src/__tests__/deposit-asset-pack-option-admission.test.ts',
  routeModel: 'apps/uapi/components/deposits/models/deposit-route-model.ts',
  client: 'apps/uapi/components/deposits/DepositPageClient/DepositPageClient.tsx',
  routeModelTest: 'apps/uapi/tests/depositRouteModel.test.ts',
  pageTest: 'apps/uapi/tests/depositPageClient.test.tsx',
  ...
  uapiJestConfig: 'apps/uapi/jest.config.cjs',
  packageIndex: 'packages/asset-packs-pipelines/domain/src/index.ts',
  packageManifest: 'packages/asset-packs-pipelines/domain/package.json',
  protocolIndex: 'scripts/specifying/src/index.js',
  protocolTypes: 'scripts/specifying/src/index.d.ts',
  protocolTest: 'scripts/specifying/test/v43-deposit-option-admission.test.js',
...
function buildPredicateResults(repoRoot) {
  ...
  return [
    ...
    predicateResult('uapi-jest-maps-admission', SOURCE_ROOTS.uapiJestConfig, sources.uapiJestConfig.includes('@bitcode/asset-packs-pipelines-execution-pipeline-sdivf-synthesize-deposits-asset-packs/deposit-asset-pack-option-admission')),
