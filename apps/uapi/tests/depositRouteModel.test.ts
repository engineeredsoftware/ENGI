...
describe('deposit-route-model', () => {
  ...
  it('keeps deposit submission blocked until option review is present', () => {
    const session = buildDepositRouteSession({
      ...
      sourceBranch: 'main',
      sourceCommit: '31bbc0c5227b6b3aed5d107fd8507d35ec22970a',
      permissibleSources: ['packages/asset-packs-pipelines/syntheses/deposit/src/deposit-asset-pack-options.ts'],
  ...
  it('keeps critical or negative-value policy blocked before Gate 7 admission', () => {
    const session = buildDepositRouteSession({
      ...
      sourceBranch: 'main',
      sourceCommit: '31bbc0c5227b6b3aed5d107fd8507d35ec22970a',
      permissibleSources: ['packages/asset-packs-pipelines/syntheses/deposit/src/deposit-asset-pack-option-policy.ts'],
