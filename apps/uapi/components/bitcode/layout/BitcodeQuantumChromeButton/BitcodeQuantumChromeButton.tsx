    ...
    >
      ...
      <span className="relative z-10 inline-flex items-center gap-2.5">
        <span
          ...
          className="relative inline-flex h-3.5 w-3.5 origin-center transition-transform duration-300 ease-out group-hover:rotate-[14.875deg] group-hover:drop-shadow-[0_0_8px_rgba(103,254,183,0.85)] group-disabled:rotate-0"
        >
          <Logo
            height="h-3.5"
            width="w-3.5"
