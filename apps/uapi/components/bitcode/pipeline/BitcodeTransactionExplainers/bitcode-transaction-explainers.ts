...
const TRANSACTION_EXPLAINER_SOURCE_REFS = [
  ...
  'apps/uapi/components/bitcode/pipeline/BitcodeTransactionsFilterBar.tsx',
  ...
  pageSize: buildExplainer({
    ...
    references: {
      source: [
        ...
        'apps/uapi/components/bitcode/pipeline/BitcodeTransactionsPagination.tsx',
      ],
...
export const BITCODE_PAYLOAD_INSPECTOR_EXPLAINERS = {
  modes: buildExplainer({
    ...
    references: {
      source: [
        ...TRANSACTION_EXPLAINER_SOURCE_REFS,
        'apps/uapi/components/bitcode/pipeline/BitcodePayloadInspector.tsx',
      ],
      canon: [...TRANSACTION_EXPLAINER_CANON_REFS],
    },
  }),
  structuredPayload: buildExplainer({
    ...
    references: {
      source: [
        ...TRANSACTION_EXPLAINER_SOURCE_REFS,
        'apps/uapi/components/bitcode/pipeline/BitcodePayloadShape.tsx',
      ],
      canon: [...TRANSACTION_EXPLAINER_CANON_REFS],
    },
  }),
  payloadTree: buildExplainer({
    ...
    references: {
      source: [
        ...TRANSACTION_EXPLAINER_SOURCE_REFS,
        'apps/uapi/components/bitcode/pipeline/BitcodePayloadTree.tsx',
      ],
      canon: [...TRANSACTION_EXPLAINER_CANON_REFS],
    },
  }),
