/**
 * ProductSynthesizeDataPackOptionsButton — primary “Synthesize DataPack Options”
...
export function ProductSynthesizeDataPackOptionsButton({
  onClick,
  disabled = false,
  running = false,
  'data-testid': dataTestId,
  className = '',
}: ProductSynthesizeDataPackOptionsButtonProps) {
...
export default ProductSynthesizeDataPackOptionsButton;
