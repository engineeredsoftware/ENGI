...
export const chatGptAppSections = [
  {
    ...
    detail:
      'Its answers should map back to /exchange records and proof readback. The app may be conversational, but the proof and state contract remains Bitcode.',
    reason:
    ...
    points: [
      ...
      'Attach source, output destinations, Read intent, and DataPack references as structured context.',
      'Return /exchange links or activity IDs for reread.',
    ],
  },
  {
    id: 'safe-results',
    ...
    summary:
      'A good ChatGPT App response should say what it did, what is staged, what is blocked, and where the user can verify the result in /exchange or the relevant route.',
    detail:
      'This is the same write/read discipline as the action guide, adapted for conversational operation.',
    reason:
      'Users should never have to trust a chat transcript when /exchange and route readback can show the actual state.',
  },
