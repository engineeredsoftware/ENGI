...
/**
 * Pipeline phase poetry overlay for marketing/demo execution narratives.
 * Templates, colors, and quality gate live in co-located data module.
 */
import React, { useState, useEffect, useRef, useMemo } from 'react';
import { motion, AnimatePresence } from 'framer-motion';

import {
  PHASE_POETRY_TEMPLATES,
  EMOTIONAL_COLORS,
  POETRY_QUALITY,
} from './marketing-pipeline-phase-poetry-data';
