...
export const DEPOSIT_SECTION_EXPLAINERS = {
  readback: buildExplainer({
    ...
    references: {
      source: [...DEPOSIT_SOURCE_REFS, 'apps/uapi/components/deposits/models/deposit-route-model.ts'],
  ...
  provider: buildExplainer({
    ...
    references: {
      source: [...DEPOSIT_SOURCE_REFS, 'apps/uapi/components/bitcode/pipeline/models/repository-context.ts'],
      canon: DEPOSIT_CANON_REFS,
    },
  }),
  repository: buildExplainer({
    ...
    references: {
      source: ['apps/uapi/components/deposits/DepositSourceSelection/DepositSourceSelection.tsx', 'apps/uapi/components/bitcode/pipeline/models/repository-context.ts'],
      canon: [
        ...DEPOSIT_CANON_REFS,
  ...
  branch: buildExplainer({
    ...
    references: { source: ['apps/uapi/components/deposits/DepositSourceSelection/DepositSourceSelection.tsx'], canon: DEPOSIT_CANON_REFS },
  }),
  ...
  refreshProviderConnection: buildExplainer({
    ...
    references: {
      source: ['apps/uapi/components/deposits/DepositSourceSelection/DepositSourceSelection.tsx'],
      canon: DEPOSIT_CANON_REFS,
    },
  }),
  ...
  forcedInclusions: buildExplainer({
    ...
    points: [
      ...
      'Use this on monorepos to keep measurement bounded (e.g. apps/uapi/)',
