 ...
 * (retired product name Packs; component tree under exchange/).
 *
 ...
 * Network-scope PackActivity only. Fetch in `use-exchange-activity`; URL in
 * `use-exchange-route-params`.
 */
...
import { formatCount } from "@/components/exchange/models/exchange-format";
import { useExchangeActivity } from "./hooks/use-exchange-activity";
import { useExchangeRouteParams } from "./hooks/use-exchange-route-params";
import { ExchangeActivityMaster } from "@/components/exchange/ExchangeActivityMaster/ExchangeActivityMaster";
import { ExchangeActivityDetail } from "@/components/exchange/ExchangeActivityDetail/ExchangeActivityDetail";
import { ExchangePortfolioStrip } from "@/components/exchange/ExchangePortfolioStrip/ExchangePortfolioStrip";
...
export default function ExchangePageClient() {
  ...
  const {
    ...
    error,
    refresh,
  } = useExchangeActivity(routeParams, detailId);
    ...
    >
      ...
      */}
      ...
      >
        ...
        />
        <ExchangeActivityDetail detail={detail} layout="aside" />
      </ProductDetailStage>
    </ProductRouteShell>
  );
}
