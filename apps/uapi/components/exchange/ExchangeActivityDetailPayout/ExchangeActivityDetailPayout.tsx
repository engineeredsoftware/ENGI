...
export type ExchangeActivityDetailPayoutProps = {
  settleRunId: string;
...
export function ExchangeActivityDetailPayout({
  settleRunId,
  pendingPayout,
  canFinalize = false,
  ...
  isBuyer = false,
  onFinalized,
}: ExchangeActivityDetailPayoutProps) {
  ...
  return (
    <ExchangeDetailSection title="Payout (seller review)">
