...
import { formatSats } from "@/components/exchange/models/exchange-format";
import { ExchangeDetailSection } from "@/components/exchange/ExchangeDetailSection/ExchangeDetailSection";

export type ExchangeActivityDetailAccountingProps = {
  accounting: NonNullable<PackActivityDetailProjection["accounting"]>;
};

export function ExchangeActivityDetailAccounting({
  accounting,
}: ExchangeActivityDetailAccountingProps) {
  return (
    <ExchangeDetailSection title="Accounting">
