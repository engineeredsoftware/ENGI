...
export type ExchangeActivityDetailStatesProps = {
  detail: PackActivityDetailProjection;
};

export function ExchangeActivityDetailStates({
  detail,
}: ExchangeActivityDetailStatesProps) {
  const showRepair =
  ...
  return (
    <>
      <ExchangeDetailSection title="State readback">
      ...
      {showRepair ? (
        <ExchangeDetailSection title="Repair surface">
          <div className="grid gap-2 text-sm">
            <div className="flex items-center justify-between gap-3">
              <ExchangeStatusPill
