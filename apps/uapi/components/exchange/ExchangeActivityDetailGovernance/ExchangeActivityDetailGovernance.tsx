...
export type ExchangeActivityDetailGovernanceProps = {
  governance: NonNullable<PackActivityDetailProjection["governance"]>;
};

export function ExchangeActivityDetailGovernance({
  governance,
}: ExchangeActivityDetailGovernanceProps) {
  return (
    <ExchangeDetailSection title="Governance">
