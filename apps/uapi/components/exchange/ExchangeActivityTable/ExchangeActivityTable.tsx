...
} from "@/components/exchange/models/exchange-column-explainers";
import { ExchangeStatusPill } from "@/components/exchange/ExchangeStatusPill/ExchangeStatusPill";
...
export type ExchangeActivityTableProps = {
...
export function ExchangeActivityTable({
  records,
  selectedId,
  isLoading,
  error,
              ...
              return (
                ...
                >
                  ...
                  <td className={PRODUCT_DATA_TABLE_TD_CLASS}>
                    <ExchangeStatusPill value={record.settlementState} />
                  </td>
                  <td className={PRODUCT_DATA_TABLE_TD_CLASS}>
                    <ExchangeStatusPill value={record.deliveryState} />
                  </td>
                  <td
                    className={`${PRODUCT_DATA_TABLE_TD_CLASS} text-sm text-neutral-200`}
                  >
