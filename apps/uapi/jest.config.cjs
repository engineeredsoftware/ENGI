...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@bitcode/generic-mcps-bitcode$': '<rootDir>/../apps/mcp/src/index.ts',
    '^@bitcode/mcp-generics$': '<rootDir>/../../packages/mcp-generics/src/index.ts',
    '^@bitcode/asset-packs-pipelines-execution-pipeline-sdivf-synthesize-deposits-asset-packs$': '<rootDir>/../../packages/asset-packs-pipelines/execution-pipeline-sdivf-synthesize-deposits-asset-packs/src/index.ts',
    '^@bitcode/asset-packs-pipelines-execution-pipeline-sdivf-synthesize-reads-asset-packs$': '<rootDir>/../../packages/asset-packs-pipelines/execution-pipeline-sdivf-synthesize-reads-asset-packs/src/index.ts',
    '^@bitcode/asset-packs-pipelines-execution-pipeline-simple-settle-asset-pack$': '<rootDir>/../../packages/asset-packs-pipelines/execution-pipeline-simple-settle-asset-pack/src/index.ts',
