...
module.exports = {
  ...
  testMatch: [
    ...
    '<rootDir>/tests/readBuyerMeasurementProjection.test.ts',
    '<rootDir>/tests/lib/githubAppUrl.test.ts',
    '<rootDir>/tests/api/walletEthereumCanonicalUser.test.ts',
    '<rootDir>/tests/api/walletSessionRoute.test.ts',
