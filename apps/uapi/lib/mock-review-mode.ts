...
export function buildMockAuxillariesData(): MockAuxillariesData {
  ...
  return {
    ...
    modelPreferences: {
      ...
      temperature: 0.4,
      max_tokens: 3200,
      review_profile: 'bitcode-product-demo',
    },
    onboardedPanes,
    onboarded_steps: onboardedPanes,
    isOnboardingComplete: true,
  ...
  return [
    {
      ...
      description: 'Primary Bitcode product workspace and route-local composition carrier.',
      private: true,
      defaultBranch: 'main',
    ...
    },
    {
      ...
      description: 'Settlement, accounting, and proof-publishing surfaces feeding Packs and Reads.',
      private: true,
      defaultBranch: 'main',
