...
- Headers: a singular auxillary header per pane for consistent title/copy.
  Retained `apps/uapi/app/orbitals/components/headers/*` files are redirect-support re-exports only; canonical header ownership lives under `apps/uapi/app/auxillaries/components/headers/*`.

2) Component Placement

- Canonical route/overlay implementation now lives under: `apps/uapi/app/auxillaries/components/*`
...
- Retained implementation internals still live under: `apps/uapi/app/orbitals/components/*`
  - Redirect-support wrappers and re-exports only; canonical pane logic and lower-level helper ownership now live under `apps/uapi/app/auxillaries/components/*`
- Experience boundaries:
  - Marketing: `apps/uapi/app/(root)/components/*`
  - Executions: `apps/uapi/app/executions/components/*`
  - Conversations: `apps/uapi/app/conversations/components/*`
  - Shared across experiences: `apps/uapi/components/bitcode/*`
