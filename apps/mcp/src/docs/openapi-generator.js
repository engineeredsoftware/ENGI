...
exports.generateOpenAPIFiles = generateOpenAPIFiles;
...
The Model Context Protocol (MCP) server exposing Bitcode’s technical knowledge via standardized tools, resources, and prompts.
...
function generateOpenAPIFiles() {
    ...
    const docsDir = (0, path_1.join)(process.cwd(), 'docs', 'openapi');
    if (!(0, fs_1.existsSync)(docsDir)) {
        (0, fs_1.mkdirSync)(docsDir, { recursive: true });
    }
    // Save JSON specification
    const jsonPath = (0, path_1.join)(docsDir, 'bitcode-mcp-openapi.json');
    (0, fs_1.writeFileSync)(jsonPath, JSON.stringify(spec, null, 2));
    // Save YAML specification
    const yamlPath = (0, path_1.join)(docsDir, 'bitcode-mcp-openapi.yaml');
