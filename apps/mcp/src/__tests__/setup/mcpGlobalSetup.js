...
async function createTestDirectories() {
    ...
    for (const dir of testDirs) {
        const fullPath = (0, path_1.join)(rootDir, dir);
...
async function initializeTestData() {
    ...
    const testDataDir = (0, path_1.join)(process.cwd(), 'tmp/test-data');
    ...
    (0, fs_1.writeFileSync)((0, path_1.join)(testDataDir, 'mock-github-data.json'), JSON.stringify(mockRepoData, null, 2));
    ...
    (0, fs_1.writeFileSync)((0, path_1.join)(testDataDir, 'mock-pipeline-data.json'), JSON.stringify(mockPipelineData, null, 2));
    ...
    (0, fs_1.writeFileSync)((0, path_1.join)(testDataDir, 'mock-user-data.json'), JSON.stringify(mockUserData, null, 2));
...
async function setupPerformanceMonitoring() {
    ...
    (0, fs_1.writeFileSync)((0, path_1.join)(metricsDir, 'performance-config.json'), JSON.stringify(perfConfig, null, 2));
...
async function validateTestPrerequisites() {
    ...
    for (const file of requiredFiles) {
        const filePath = (0, path_1.join)(testDataDir, file);
