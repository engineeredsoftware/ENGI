...
exports.registerDevelopmentPrompts = registerDevelopmentPrompts;
const zod_1 = require("zod");
/**
 * API development prompt
 */
const apiDevelopmentPrompt = {
...
Perfect for API development, microservices creation, and API modernization projects.`,
    arguments: zod_1.z.object({
        apiName: zod_1.z.string().describe('Name of the API to develop'),
        description: zod_1.z.string().describe('Description of the API functionality'),
        repository: zod_1.z.object({
            owner: zod_1.z.string(),
            name: zod_1.z.string(),
            branch: zod_1.z.string().optional().default('main')
        }).describe('Target repository for API development'),
        apiType: zod_1.z.enum(['rest', 'graphql', 'grpc', 'websocket']).default('rest')
        ...
        authentication: zod_1.z.enum(['jwt', 'oauth2', 'api-key', 'basic', 'none']).default('jwt')
 ...
 */
const frontendScaffoldingPrompt = {
...
Ideal for new frontend projects, component libraries, and modernization efforts.`,
    arguments: zod_1.z.object({
        projectName: zod_1.z.string().describe('Name of the frontend project'),
        description: zod_1.z.string().describe('Description of the frontend application'),
        repository: zod_1.z.object({
            owner: zod_1.z.string(),
            name: zod_1.z.string(),
            branch: zod_1.z.string().optional().default('main')
        }).describe('Target repository for frontend project'),
        framework: zod_1.z.enum(['react', 'vue', 'angular', 'svelte', 'solid']).default('react')
            .describe('Frontend framework to use'),
        typescript: zod_1.z.boolean().default(true)
            .describe('Use TypeScript for type safety'),
        styling: zod_1.z.enum(['css-modules', 'styled-components', 'emotion', 'tailwind', 'scss']).default('tailwind')
            .describe('Styling approach to implement'),
        stateManagement: zod_1.z.enum(['redux', 'zustand', 'mobx', 'context', 'recoil']).optional()
            .describe('State management solution'),
        testing: zod_1.z.enum(['jest', 'vitest', 'cypress', 'playwright']).default('jest')
            .describe('Testing framework to set up'),
        features: zod_1.z.array(zod_1.z.enum([
        ...
        designSystem: zod_1.z.string().optional()
 ...
 */
const databaseIntegrationPrompt = {
...
Perfect for database integration, data modeling, and persistence layer development.`,
    arguments: zod_1.z.object({
        databaseType: zod_1.z.enum(['postgresql', 'mysql', 'mongodb', 'sqlite', 'redis']).default('postgresql')
        ...
        orm: zod_1.z.enum(['prisma', 'typeorm', 'sequelize', 'mongoose', 'drizzle']).optional()
 ...
 */
function registerDevelopmentPrompts() {
    return [
