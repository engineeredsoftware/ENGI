...
exports.registerWorkflowPrompts = registerWorkflowPrompts;
...
Perfect for new feature development, enhancement requests, and product improvements.`,
    arguments: zod_1.z.object({
        featureName: zod_1.z.string().describe('Name of the feature to implement'),
        requirements: zod_1.z.string().describe('Detailed feature requirements and acceptance criteria'),
        repository: zod_1.z.object({
            owner: zod_1.z.string(),
            name: zod_1.z.string(),
            branch: zod_1.z.string().optional().default('main')
        }).describe('Target repository information'),
        complexity: zod_1.z.enum(['simple', 'medium', 'complex']).optional().default('medium')
        ...
        timeline: zod_1.z.string().optional().describe('Target timeline or deadline'),
        constraints: zod_1.z.array(zod_1.z.string()).optional().default([])
...
Ideal for bug reports, production issues, and quality improvements.`,
    arguments: zod_1.z.object({
        bugDescription: zod_1.z.string().describe('Detailed description of the bug'),
        repository: zod_1.z.object({
            owner: zod_1.z.string(),
            name: zod_1.z.string(),
            branch: zod_1.z.string().optional().default('main')
        ...
        reproductionSteps: zod_1.z.array(zod_1.z.string()).optional().default([])
            .describe('Steps to reproduce the bug'),
        affectedUsers: zod_1.z.string().optional().describe('Description of affected users or systems'),
        errorLogs: zod_1.z.string().optional().describe('Relevant error logs or stack traces'),
        expectedBehavior: zod_1.z.string().optional().describe('What should happen instead'),
        environment: zod_1.z.string().optional().describe('Environment where bug occurs (prod, staging, etc.)')
    }),
    getMessages: async (args) => [
        {
            role: 'user',
 ...
 */
const codeReviewWorkflowPrompt = {
...
Perfect for PR reviews, code audits, and quality assurance.`,
    arguments: zod_1.z.object({
        ...
        pullRequestNumber: zod_1.z.number().optional().describe('Specific PR number to review'),
        commitHash: zod_1.z.string().optional().describe('Specific commit to review'),
        ...
        reviewDepth: zod_1.z.enum(['surface', 'standard', 'comprehensive']).optional().default('standard')
            .describe('Depth of the code review'),
        compliance: zod_1.z.array(zod_1.z.string()).optional().default([])
...
Perfect for architecture decisions, modernization planning, and design reviews.`,
    arguments: zod_1.z.object({
        ...
        scope: zod_1.z.enum(['full-system', 'component', 'integration']).optional().default('full-system')
        ...
        futureRequirements: zod_1.z.string().optional()
...
Ideal for performance issues, optimization requests, and efficiency improvements.`,
    arguments: zod_1.z.object({
        ...
        performanceIssues: zod_1.z.array(zod_1.z.string()).optional().default([])
            .describe('Known performance issues or symptoms'),
        targetMetrics: zod_1.z.record(zod_1.z.string()).optional().default({})
            .describe('Target performance metrics (e.g., load time, throughput)'),
        scope: zod_1.z.enum(['frontend', 'backend', 'database', 'full-stack']).optional().default('full-stack')
 ...
 */
function registerWorkflowPrompts() {
    return [
