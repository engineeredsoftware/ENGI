...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@bitcode/specifying$': '<rootDir>/../packages/specifying/src/index.js',
    '^@bitcode/specifying/src/(.+)$': '<rootDir>/../packages/specifying/src/$1',
    ...
    '^@bitcode/generic-tools-(.+)$': '<rootDir>/../packages/generic-tools/$1/src/index.ts',
    '^@bitcode/asset-packs-pipelines-domain/read-need$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/read-need.ts',
    '^@bitcode/asset-packs-pipelines-domain/asset-packs-synthesis$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/asset-packs-synthesis.ts',
    '^@bitcode/asset-packs-pipelines-domain/deposit-option-real-synthesis$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-option-real-synthesis.ts',
    '^@bitcode/asset-packs-pipelines-domain/runtime-inference-policy$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/runtime-inference-policy.ts',
    ...
    '^@bitcode/asset-packs-pipelines-domain/read-need-review-resynthesis$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/read-need-review-resynthesis.ts',
    '^@bitcode/asset-packs-pipelines-domain/reading-interface-product-parity$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/reading-interface-product-parity.ts',
    '^@bitcode/asset-packs-pipelines-domain/reading-pipeline-contract$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/reading-pipeline-contract.ts',
    '^@bitcode/asset-packs-pipelines-domain/deposit-asset-pack-options$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-asset-pack-options.ts',
    '^@bitcode/asset-packs-pipelines-domain/deposit-asset-pack-option-policy$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-asset-pack-option-policy.ts',
    '^@bitcode/asset-packs-pipelines-domain/deposit-asset-pack-option-admission$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-asset-pack-option-admission.ts',
    '^@bitcode/asset-packs-pipelines-domain/depositor-earning-supply-intelligence$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/depositor-earning-supply-intelligence.ts',
    ...
    '^@bitcode/generic-mcps-bitcode$': '<rootDir>/../packages/generic-mcps/bitcode/src/index.ts',
    '^@bitcode/mcp-generics$': '<rootDir>/../packages/mcp-generics/src/index.ts',
    '^@bitcode/asset-packs-pipelines-synthesize-deposits-asset-packs-pipeline$': '<rootDir>/../packages/asset-packs-pipelines/synthesize-deposits-asset-packs-pipeline/src/index.ts',
    '^@bitcode/asset-packs-pipelines-synthesize-reads-asset-packs-pipeline$': '<rootDir>/../packages/asset-packs-pipelines/synthesize-reads-asset-packs-pipeline/src/index.ts',
    '^@bitcode/asset-packs-pipelines-settle-asset-pack-pipeline$': '<rootDir>/../packages/asset-packs-pipelines/settle-asset-pack-pipeline/src/index.ts',
