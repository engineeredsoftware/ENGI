...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@bitcode/generic-tools-(.+)$': '<rootDir>/../packages/generic-tools/$1/src/index.ts',
    '^@bitcode/pipeline-asset-pack/read-need$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/read-need.ts',
    '^@bitcode/pipeline-asset-pack/asset-packs-synthesis$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/asset-packs-synthesis.ts',
    '^@bitcode/pipeline-asset-pack/deposit-option-real-synthesis$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-option-real-synthesis.ts',
    '^@bitcode/pipeline-asset-pack/runtime-inference-policy$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/runtime-inference-policy.ts',
    '^@bitcode/pipeline-asset-pack/asset-pack-commodity-state$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/asset-pack-commodity-state.ts',
    '^@bitcode/pipeline-asset-pack/read-need-review-resynthesis$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/read-need-review-resynthesis.ts',
    '^@bitcode/pipeline-asset-pack/reading-interface-product-parity$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/reading-interface-product-parity.ts',
    '^@bitcode/pipeline-asset-pack/reading-pipeline-contract$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/reading-pipeline-contract.ts',
    '^@bitcode/pipeline-asset-pack/deposit-asset-pack-options$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-asset-pack-options.ts',
    '^@bitcode/pipeline-asset-pack/deposit-asset-pack-option-policy$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-asset-pack-option-policy.ts',
    '^@bitcode/pipeline-asset-pack/deposit-asset-pack-option-admission$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/deposit-asset-pack-option-admission.ts',
    '^@bitcode/pipeline-asset-pack/depositor-earning-supply-intelligence$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/depositor-earning-supply-intelligence.ts',
    '^@bitcode/pipeline-asset-pack/organization-policy-wallet-authority$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/organization-policy-wallet-authority.ts',
    '^@bitcode/pipeline-asset-pack/src/(.+)$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/$1',
    ...
    '^@bitcode/pipeline-asset-pack$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/index.ts',
    '^@bitcode/engine/pipeline$': '<rootDir>/../packages/asset-packs-pipelines/domain/src/run.ts',
    ...
    '^@bitcode/asset-packs-pipelines-synthesize-deposits$': '<rootDir>/../packages/asset-packs-pipelines/synthesize-deposits/src/index.ts',
    '^@bitcode/asset-packs-pipelines-synthesize-reads$': '<rootDir>/../packages/asset-packs-pipelines/synthesize-reads/src/index.ts',
    '^@bitcode/asset-packs-pipelines-settle-asset-packs$': '<rootDir>/../packages/asset-packs-pipelines/settle-reads/src/index.ts',
    '^@bitcode/generic-pipelines-simple$': '<rootDir>/../packages/generic-pipelines/Simple/src/index.ts',
