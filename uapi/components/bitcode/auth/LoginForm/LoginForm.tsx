...
import SocialLoginButton from '@/components/bitcode/auth/SocialLoginButton/SocialLoginButton'
      ...
      if (error) {
        ...
        setTimeout(async () => {
          ...
          if (completedOnboarding) {
            // Return to the live Bitcode Terminal instead of the former demo route.
            onClose?.()
            try {
