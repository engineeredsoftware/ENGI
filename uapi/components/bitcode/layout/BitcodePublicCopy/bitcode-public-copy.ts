export const BITCODE_PUBLIC_COPY = {
  ...
  description:
    'Deposit AssetPacks synthesized from source-code, listing only IP you approve. Find AssetPacks containing specific knowledge and buy them for Bitcoin. Settlement is proven on a fully open-source, decentralized, and auditable ledger.',
