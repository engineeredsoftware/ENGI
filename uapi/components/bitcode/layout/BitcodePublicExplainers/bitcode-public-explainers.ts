...
export const BITCODE_PUBLIC_EXPLAINERS = {
  network: buildExplainer({
    ...
    references: {
      source: ['uapi/app/packs/page.tsx', 'uapi/components/packs/PacksPageClient/PacksPageClient.tsx'],
      canon: [...V48_CANON],
    },
  }),
  read: buildExplainer({
    ...
    references: {
      source: ['uapi/app/reads/page.tsx', 'uapi/components/reads/'],
      canon: [...V48_CANON],
    },
  }),
  deposit: buildExplainer({
    ...
    references: {
      source: ['uapi/app/deposits/page.tsx', 'uapi/components/deposits/'],
      canon: [...V48_CANON],
    },
  }),
  transactions: buildExplainer({
    ...
    references: {
      source: ['uapi/app/packs/page.tsx', 'uapi/components/packs/'],
      canon: [...V48_CANON],
    },
  }),
  docs: buildExplainer({
    ...
    references: {
      source: ['uapi/app/docs/', 'uapi/components/docs/'],
      canon: [...V48_CANON],
    },
  }),
