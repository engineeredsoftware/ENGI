...
const FlipText = dynamic(() => import("@/components/bitcode/layout/sidebars/FlipText/FlipText"), {
  ssr: false,
  loading: () => <span className="inline-block">Login</span>,
});

const AuxillariesLoginPane = dynamic(() => import("@/components/auxillaries/AuxillariesLoginPane/AuxillariesLoginPane"), {
  ssr: false,
  loading: () => <div className="animate-pulse h-96 w-full" />,
});

const AuxillariesContent = dynamic(() => import("@/components/auxillaries/AuxillariesContent/AuxillariesContent"), {
  ssr: false,
  loading: () => <div className="animate-pulse h-96 w-full" />,
});

const ProfilePane = dynamic(() => import("@/components/auxillaries/AuxillariesProfilePane/AuxillariesProfilePane"), {
  ssr: false,
  loading: () => <div className="animate-pulse h-64 w-full" />,
});

const ExternalsPane = dynamic(() => import("@/components/auxillaries/AuxillariesExternalsPane/AuxillariesExternalsPane"), {
  ssr: false,
  loading: () => <div className="animate-pulse h-64 w-full" />,
});

const WalletPane = dynamic(() => import("@/components/auxillaries/AuxillariesWalletPane/AuxillariesWalletPane"), {
  ssr: false,
  loading: () => <div className="animate-pulse h-64 w-full" />,
});

const InterfacesPane = dynamic(() => import("@/components/auxillaries/AuxillariesInterfacesPane/AuxillariesInterfacesPane"), {
  ssr: false,
  loading: () => <div className="animate-pulse h-64 w-full" />,
});
