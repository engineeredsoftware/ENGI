  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <div className="flex items-center gap-2 rounded-none border border-white/8 bg-white/5 px-3 py-2 text-[0.66rem] uppercase tracking-[0.2em] text-neutral-300">
        ...
        <button
          ...
          className="rounded-none border border-emerald-400/30 bg-emerald-400/10 px-4 py-3 text-sm font-medium text-emerald-100 transition hover:border-emerald-300/50 hover:bg-emerald-400/15 disabled:cursor-not-allowed disabled:opacity-60"
        >
        ...
        <button
          ...
          className="rounded-none border border-red-400/25 bg-red-400/10 px-4 py-3 text-sm font-medium text-red-100 transition hover:border-red-300/45 hover:bg-red-400/15 disabled:cursor-not-allowed disabled:opacity-60"
        >
          Reject Read
        </button>
        <button
          ...
          className="rounded-none border border-amber-400/25 bg-amber-400/10 px-4 py-3 text-sm font-medium text-amber-100 transition hover:border-amber-300/45 hover:bg-amber-400/15 disabled:cursor-not-allowed disabled:opacity-60"
        >
        ...
        <button
          ...
          className="rounded-none border border-emerald-400/30 bg-emerald-400/10 px-4 py-3 text-sm font-medium text-emerald-100 transition hover:border-emerald-300/50 hover:bg-emerald-400/15"
        >
        ...
        <button
          ...
          className="rounded-none border border-white/10 bg-white/5 px-4 py-3 text-sm font-medium text-neutral-100 transition hover:border-white/18 hover:bg-white/10"
        >
          Focus asset-pack fit
        </button>
      </div>

      <label className="mt-4 block rounded-none border border-white/8 bg-black/20 px-4 py-4">
        ...
        <textarea
          ...
          className="mt-3 w-full resize-none rounded-none border border-white/8 bg-black/30 px-3 py-3 text-sm leading-6 text-neutral-100 outline-none transition placeholder:text-neutral-600 focus:border-emerald-300/35"
        />
      </label>
