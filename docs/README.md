# Bitcode engineering documentation

| Doc | Purpose |
| --- | --- |
| [AGENTS.md](./AGENTS.md) | Rules for AI/human agents working in this monorepo |
| [APPS.md](./APPS.md) | Commercial apps — primarily `apps/uapi` |
| [FAMILIARIZATION.md](./FAMILIARIZATION.md) | Package catalog, inheritance, request path |
