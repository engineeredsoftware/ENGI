...
| `internal-docs/THE_CODELESS_CUSTOMER_EXPERIENCE.md` | `internal-docs/BITCODE_TERMINAL_OPERATOR_EXPERIENCE.md` | notes teach Terminal operator Read review, fit review, settlement, and AssetPack UX |
